...
require_once JPATH_ADMINISTRATOR.'/components/com_rsform/helpers/fields/advcheckbox.php';

class RSFormProFieldFoundationAdvcheckbox extends RSFormProFieldAdvcheckbox
{	
