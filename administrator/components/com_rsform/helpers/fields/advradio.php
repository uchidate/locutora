...
class RSFormProFieldAdvRadio extends RSFormProFieldMultiple
{
	protected $glue = '';
	protected $start = '';
	protected $end = '';
	...
	public function buildItem($data) {
        $html = '<div class="rsfpa-radio rsfpa-' . strtolower($this->getProperty('FLOW')) . '">' .
