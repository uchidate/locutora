		...
		<table class="table table-striped table-bordered">
			<thead>
				<tr>
					...
					<th class="center text-center"><?php echo JText::_('COM_RSSEO_GA_BROWSERS_VISITS'); ?></th>
					<th class="center text-center"><?php echo JText::_('COM_RSSEO_GA_BROWSERS_PAGEVISITS'); ?></th>
					<th class="center text-center"><?php echo JText::_('COM_RSSEO_GA_BROWSERS_BOUNCERATE'); ?></th>
					<th class="center text-center"><?php echo JText::_('COM_RSSEO_GA_BROWSERS_AVGTIME'); ?></th>
				</tr>
			</thead>
			<tbody>
