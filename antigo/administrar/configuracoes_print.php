...
$layout = new TLayout("print", "CoralCoral", "MobileCoral");
$layout->version = 2;
...
$page_layouts["configuracoes_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "configuracoes" );
