...
require_once("include/Painel_variables.php");
...
$layout = new TLayout("dashboard", "CoralCoral", "MobileCoral");
$layout->version = 2;
...
$page_layouts["Painel_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("Painel", "dashboard");
