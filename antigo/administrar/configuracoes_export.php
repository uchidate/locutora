...
require_once("include/configuracoes_variables.php");
...
$layout = new TLayout("export2", "CoralCoral", "MobileCoral");
$layout->version = 2;
...
$page_layouts["configuracoes_export"] = $layout;
...
if( @$_REQUEST["a"] != "" )
{
	...
	if (@$_REQUEST["mdelete"])
	{
		...
		{
			$keys=array();
			$keys["idconf"] = refine($_REQUEST["mdelete1"][mdeleteIndex($ind)]);
			$selected_recs[] = $keys;
		}
	}
