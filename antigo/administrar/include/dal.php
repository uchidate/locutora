...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("admin");
}
...
class tDAL
{
	...
	var $clientes;
	var $configuracoes;
	var $locutoracom_uggroups;
	var $locutoracom_ugmembers;
	var $locutoracom_ugrights;
	var $paginas;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "admin", "varname" => "admin", "connId" => "locutora11_at_locutora_com");
		$this->lstTables[] = array("name" => "clientes", "varname" => "clientes", "connId" => "locutora11_at_locutora_com");
		$this->lstTables[] = array("name" => "configuracoes", "varname" => "configuracoes", "connId" => "locutora11_at_locutora_com");
		$this->lstTables[] = array("name" => "locutoracom_uggroups", "varname" => "locutoracom_uggroups", "connId" => "locutora11_at_locutora_com");
		$this->lstTables[] = array("name" => "locutoracom_ugmembers", "varname" => "locutoracom_ugmembers", "connId" => "locutora11_at_locutora_com");
		$this->lstTables[] = array("name" => "locutoracom_ugrights", "varname" => "locutoracom_ugrights", "connId" => "locutora11_at_locutora_com");
		$this->lstTables[] = array("name" => "paginas", "varname" => "paginas", "connId" => "locutora11_at_locutora_com");
	}
