...
$pageMask[$table] = $mask;
$tables[$table] = array("admin", " " . "Admin");
$table = "paginas";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("paginas", " " . "Paginas");
$table = "configuracoes";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("configuracoes", " " . "Configuracoes");
$table = "clientes";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("clientes", " " . "Clientes");
$table = "Painel";
$mask="";
				$mask .= "S";

$pageMask[$table] = $mask;
$tables[$table] = array("Painel", " " . "Painel");




$layout = new TLayout("ug_rights", "CoralCoral", "MobileCoral");
$layout->version = 2;
