...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("admin" == $this->chrt_array['tables'][0])
			return true;
		if("paginas" == $this->chrt_array['tables'][0])
			return true;
		if("configuracoes" == $this->chrt_array['tables'][0])
			return true;
		if("clientes" == $this->chrt_array['tables'][0])
			return true;
		if("locutoracom_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("admin" == $this->chrt_array['tables'][0])
			return true;
		if("admin" == $this->chrt_array['tables'][0])
