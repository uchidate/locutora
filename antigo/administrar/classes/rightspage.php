...
class RightsPage extends ListPage
{
	...
	function fillGroupsArr()
	{
		...
		$this->groups[-1] = "<"."Admin".">";
		$this->groups[-2] = "<"."Padrão".">";
		$this->groups[-3] = "<"."Visitante".">";
	...
	function getRights() 
	{
		...
		$sql = "select ". $this->connection->addFieldWrappers( "GroupID" ) 
			...
			." from ". $this->connection->addTableWrappers( "locutoracom_ugrights" ) 
	...
	{		
		$rightWTableName = $this->connection->addTableWrappers( "locutoracom_ugrights" );
