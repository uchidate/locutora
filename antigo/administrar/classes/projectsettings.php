...
class ProjectSettings
{
	...
	{
		return new ProjectSettings("admin", PAGE_LIST);
	}
...
{	
	...
	if("admin" == $shortTName) 
		return "admin";
	if("paginas" == $shortTName) 
		return "paginas";
	if("configuracoes" == $shortTName) 
		return "configuracoes";
	if("clientes" == $shortTName) 
		return "clientes";
