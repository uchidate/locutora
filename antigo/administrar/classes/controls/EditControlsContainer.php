...
class EditControlsContainer
{
	...
	public function EditControlsContainer($pageObject, $pSetEdit, $pageType, $cipherer = "")
	{
		if($pageObject != null)
		{
			...
			$this->pageAddLikeInline = $pageObject->pageType == PAGE_ADD && $pageObject->pageType == ADD_INLINE;
			$this->pageEditLikeInline = $pageObject->pageType == PAGE_EDIT && $pageObject->pageType == EDIT_INLINE;
