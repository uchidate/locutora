        ...
        try {
            ...
            for ($i = 0, $j = $offset; $j < $offset + $limit; $i++, $j++) {
                ...
                if (isset($item['retweeted_status'])) {
                    $fullText = $item['retweeted_status']['full_text'];
                ...
                if ($remove_spec_chars) {
                    $record['message'] = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE', $this->makeClickableLinks($fullText));
                } else {
                    $record['message'] = $this->makeClickableLinks($fullText);
                }
