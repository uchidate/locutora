...
class NTmhOAuth {
     ...
     * If 'force_nonce' is false a nonce will be generated, otherwise the value of '$this->config['force_nonce']' will
     * be used.
     *
     ...
     * If 'force_timestamp' is false a timestamp will be generated, otherwise the value of
     * '$this->config['force_timestamp']' will be used.
     *
     ...
     *
     * @return void all required OAuth parameters, safely encoded, are stored to the class variable
    ...
    private function prepare_oauth_signature() {
        $this->request_settings['oauth1_params']['oauth_signature'] = $this->safe_encode(Base64::encode(hash_hmac('sha1', $this->request_settings['basestring'], $this->request_settings['signing_key'], true)));
    }
     ...
     *
     * @return string the concatenation of the host, API version, API method and format, or $request if it begins with
     *                http
     */
