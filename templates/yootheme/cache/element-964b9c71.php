<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/herzogdupont/modules/elements/elements/hd-timeline_item/element.json
...
return [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['title', 'meta', 'content', 'image', 'image_alt', 'icon', 'timeline_icon', 'link', 'link_text']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'Panel', 
