<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/yooessentials/modules/storage-adapters/src/S3/config.json

return [
  'name' => 's3', 
  'title' => 'Amazon S3', 
  'description' => 'Create a storage from an Amazon S3 Bucket.', 
  'icon' => $filter->apply('url', '~yooessentials_url/modules/storage-adapters/src/S3/icon.svg', $file), 
  'endpoints' => [
