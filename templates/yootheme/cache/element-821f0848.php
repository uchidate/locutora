<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/herzogdupont/modules/elements/elements/hd-counter/element.json
...
return [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['text', 'number', 'unit']
        ], [
          'title' => 'Settings', 
          'fields' => ['text_size', 'text_color', 'number_size', 'number_color', 'unit_size', 'separator_locale', 'show_circle', 'percentage', 'circle_color', 'circle_radius', 'circle_stroke_width', 'duration', [
              'label' => 'General', 
              'type' => 'group', 
