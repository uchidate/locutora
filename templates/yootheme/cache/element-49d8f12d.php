<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/herzogdupont/modules/elements/elements/hd-lottie/element.json
...
return [
  ...
  'placeholder' => [
    'props' => [
      'path' => $filter->apply('url', 'assets/demo.json', $file)
    ]
  ], 
  'templates' => [
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['trigger', 'offset-top', 'loop', 'speed', 'on-mouseleave', 'animation-start', 'animation-end', 'renderer']
            ], [
              'label' => 'Link', 
              'type' => 'group', 
              'divider' => true, 
