<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/yooessentials/modules/form/elements/form_input_month/element.json
...
return [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Field', 
          'fields' => ['control_name', 'control_autofocus', 'control_id_inherit', 'control_id', 'control_label', 'control_icon', 'control_icon_align', 'control_value', 'control_readonly']
        ], [
          'title' => 'Validation', 
          'fields' => ['control_required', 'control_minmonth', 'control_maxmonth', 'control_error_message']
