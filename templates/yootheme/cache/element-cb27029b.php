<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/herzogdupont/modules/elements/elements/hd-slideshow-grid_item/element.json
...
return [
  ...
  'placeholder' => [
    'props' => [
      'image_1' => $filter->apply('url', '~yootheme/theme/assets/images/element-image-placeholder.png', $file), 
      'video_1' => '', 
      'image_2' => $filter->apply('url', '~yootheme/theme/assets/images/element-image-placeholder.png', $file), 
      'video_2' => '', 
      'image_3' => $filter->apply('url', '~yootheme/theme/assets/images/element-image-placeholder.png', $file), 
      'video_3' => '', 
      'title' => 'Title', 
      'meta' => '', 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['image_1', 'image_1_alt', 'video_1', 'thumbnail_1', 'image_2', 'image_2_alt', 'video_2', 'thumbnail_2', 'image_3', 'image_3_alt', 'video_3', 'thumbnail_3', 'title', 'meta', 'content', 'link', 'link_text', 'tags']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'Panel', 
