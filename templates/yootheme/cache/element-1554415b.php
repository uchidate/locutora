<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/yooessentials/modules/form/elements/form_input_week/element.json
...
return [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Field', 
          'fields' => ['control_name', 'control_id_inherit', 'control_autofocus', 'control_id', 'control_label', 'control_icon', 'control_icon_align', 'control_value', 'control_readonly']
        ], [
          'title' => 'Validation', 
          'fields' => ['control_required', 'control_minweek', 'control_maxweek', 'control_error_message']
