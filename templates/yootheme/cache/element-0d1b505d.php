<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/herzogdupont/modules/elements/elements/hd-slideshow-grid/element.json

return [
  '@import' => $filter->apply('path', './element.php', $file), 
  'name' => 'hd-slideshow-grid', 
  'title' => 'HD Slideshow Grid', 
  'group' => 'herzog-dupont', 
  ...
  'fields' => [
    ...
    'text_color' => [
      'label' => 'Text Color', 
      'description' => 'Set light or dark color mode for controls.', 
      'type' => 'select', 
      'options' => [
        'None' => '', 
        'Light' => 'light', 
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['panel_style', 'panel_content_padding', 'panel_size', 'panel_card_image', 'item_maxwidth', 'panel_content_width']
            ], [
              'label' => 'Title', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['slideshow_ratio', 'slideshow_min_height', 'slideshow_max_height', 'text_color', 'image_box_shadow', 'image_align', 'image_grid_width', 'image_grid_column_gap', 'image_grid_row_gap', 'image_grid_breakpoint', 'image_vertical_align', 'image_margin']
            ], [
              'label' => 'Animation', 
              'type' => 'group', 
              'divider' => true, 
