<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/yooessentials/modules/form/elements/form_radio/element.json
...
return [
  ...
  'icon' => $filter->apply('url', '~yooessentials_url/modules/form/elements/form_radio/images/icon.svg', $file), 
  'iconSmall' => $filter->apply('url', '~yooessentials_url/modules/form/elements/form_radio/images/iconSmall.svg', $file), 
  'element' => true, 
  'submittable' => true, 
  'width' => 500, 
  'defaults' => [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          ...
          'title' => 'Validation', 
          'fields' => ['control_required', 'control_error_message']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'General', 
