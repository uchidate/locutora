<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/herzogdupont/modules/elements/elements/hd-timeline/element.json
...
return [
  ...
  'fields' => [
    ...
    'line_color' => [
      'label' => 'Line Color', 
      'description' => 'Set the color for the timeline.', 
      'type' => 'color', 
      'default' => 'rgba(0, 0, 0, 0.1)'
    ], 
    'timeline_icon_color' => [
      'label' => 'Timeline Icon Color', 
    ...
    'timeline_icon_background' => [
      'label' => 'Timeline Icon Background Color', 
      'description' => 'Set the background color for the icons.', 
      'type' => 'color', 
      'default' => 'rgba(255, 255, 255, 1)'
    ], 
    'timeline_icon_border' => [
      'label' => 'Timeline Icon Border Color', 
      'description' => 'Set the border color for the icons.', 
      'type' => 'color', 
      'default' => 'rgba(0, 0, 0, 0.1)'
    ], 
    'item_margin' => [
      'label' => 'Item Margin Top', 
      'description' => 'Set the top margin for the items.', 
      'type' => 'select', 
      'default' => '', 
      'options' => [
        'Small' => 'small', 
    ...
    'align_default' => [
      ...
      'description' => 'Set the alignment of timeline items for each breakpoint. <i>Inherit</i> refers to the number of columns on the next smaller screen size.', 
      'type' => 'select', 
      'default' => 'right', 
      'options' => [
        'Left' => 'left', 
        'Right' => 'right', 
        'Left Alternate' => 'left-alternate', 
        'Right Alternate' => 'right-alternate'
      ]
    ], 
    'align_small' => [
    ...
    'panel_content_width' => [
      ...
      'show' => '!panel_style', 
      'enable' => 'show_image && image_align == \'top\' && !panel_content_padding && !item_maxwidth && (!align_default || align_default == \'1\') && (!align_small || align_small == \'1\') && (!align_medium || align_medium == \'1\') && (!align_large || align_large == \'1\') && (!align_xlarge || align_xlarge == \'1\')'
    ], 
    'title_style' => [
      'label' => 'Style', 
    ...
    'css' => [
      'label' => 'CSS', 
      'description' => 'Enter your own custom CSS. The following selectors will be prefixed automatically for this element: <code>.el-element</code>, <code>.el-item</code>, <code>.el-title</code>, <code>.el-meta</code>, <code>.el-content</code>, <code>.el-image</code>, <code>.el-link</code>, <code>.el-timeline-icon</code>', 
      'type' => 'editor', 
      'editor' => 'code', 
      'mode' => 'css', 
      'attrs' => [
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['line_color', 'timeline_icon_color', 'timeline_icon_border', 'timeline_icon_background']
            ], [
              'label' => 'Item Alignment', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['item_margin', 'align_default', 'align_small', 'align_medium', 'align_large', 'align_xlarge']
            ], [
              'label' => 'Panel', 
              'type' => 'group', 
              'divider' => true, 
