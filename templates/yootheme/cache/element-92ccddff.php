<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/yooessentials/modules/form/elements/form_select/element.json
...
return [
  ...
  'icon' => $filter->apply('url', '~yooessentials_url/modules/form/elements/form_select/images/icon.svg', $file), 
  'iconSmall' => $filter->apply('url', '~yooessentials_url/modules/form/elements/form_select/images/iconSmall.svg', $file), 
  'element' => true, 
  'submittable' => true, 
  'width' => 500, 
  'defaults' => [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Field', 
          'fields' => ['control_name', 'control_id_inherit', 'control_autofocus', 'control_id', 'control_label', 'control_value', 'control_size', 'control_width', 'control_height', 'control_multiple', 'control_options']
        ], [
          'title' => 'Validation', 
          'fields' => ['control_required', [
              'name' => '_min_max', 
              'type' => 'fields', 
