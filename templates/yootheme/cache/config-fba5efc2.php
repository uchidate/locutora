<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/yooessentials/modules/form-actions/src/SaveGoogleSheet/config.json
...
return [
  ...
  'icon' => $filter->apply('url', '~yooessentials_url/modules/form-actions/src/SaveGoogleSheet/icon.svg', $file), 
  'fields' => [
    'account' => [
      'label' => 'Account', 
      ...
      'description' => 'The Google account with which to connect to the spreadsheet.'
    ], 
    'sheet_id' => [
      'label' => 'Spreadsheet', 
    ...
    'content' => [
      ...
      'description' => 'Set the content for each column of the new entry.', 
      'endpoint' => 'yooessentials/form-action/save-gsheet/columns', 
      'watch' => 'sheet_id,sheet_name', 
      'panel' => [
        'title' => 'Content', 
        'fields' => [
          'value' => [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Action', 
          'fields' => ['account', 'sheet_id', 'sheet_name', 'value_input', 'content']
        ], [
          'title' => 'Advanced', 
