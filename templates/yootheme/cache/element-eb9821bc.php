<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/herzogdupont/modules/elements/elements/hd-toggle/element.json
...
return [
  ...
  'fields' => [
    ...
    'btn_fullwidth' => [
      ...
      'enable' => 'btn_label && btn_style && btn_style != \'link-muted\' && btn_style != \'link-text\''
    ], 
    'icon_align' => [
      'label' => 'Icon Align', 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['btn_label', 'icon', 'content', 'content2']
        ], [
          'title' => 'Settings', 
          'fields' => ['btn_style', 'btn_size', 'btn_fullwidth', 'icon_align', 'mode', 'media', 'hidden', 'target', 'cls', 'toggle_animation', 'toggle_animation_use_advanced', 'toggle_animation_advanced', 'duration', 'queued', [
              'label' => 'General', 
              'type' => 'group', 
