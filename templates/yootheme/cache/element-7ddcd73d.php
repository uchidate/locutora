<?php // $file = /home/storage/f/68/ac/locutora1/public_html/plugins/system/herzogdupont/modules/elements/elements/hd-flipcard/element.json
...
return [
  ...
  'defaults' => [
    ...
    'link_style' => 'default', 
    'link_back_text' => 'Read more', 
    'title_back_hover_style' => 'reset', 
    'title_back_element' => 'h3', 
    'title_back_align' => 'top', 
    'title_back_grid_width' => '1-2', 
    'title_back_grid_breakpoint' => 'm', 
    'meta_back_style' => 'meta', 
    'meta_back_align' => 'below-title', 
    'meta_back_element' => 'div', 
    'content_back_column_breakpoint' => 'm', 
    'icon_back_width' => 80, 
    'image_back_align' => 'top', 
    'image_back_grid_width' => '1-2', 
    'image_back_grid_breakpoint' => 'm', 
    'image_back_svg_color' => 'emphasis', 
    'link_back_style' => 'default', 
  ...
  'placeholder' => [
    'props' => [
      ...
      'title_back' => 'Title', 
      'meta_back' => '', 
      'content_back' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 
      'image_back' => '', 
      'icon_back' => ''
    ]
  ], 
  ...
  'fields' => [
    ...
    'link_text' => [
      'label' => 'Link Text', 
      'description' => 'Enter the text for the link. There is no actual link on the flip card front, it will only be used for styling purposes.', 
      'source' => true
    ], 
    'title_back' => [
      'label' => 'Title', 
    ...
    'image_back' => $config->get('builder.image'), 
    'image_back_width' => [
      'label' => 'Width', 
      'attrs' => [
        'placeholder' => 'auto'
    ...
    'link_back' => $config->get('builder.link'), 
    'link_back_target' => $config->get('builder.link_target'), 
    'link_back_text' => [
      'label' => 'Link Text', 
    ...
    'flip_animation' => [
      ...
      'description' => 'Set the flip animation.', 
      'type' => 'select', 
      'default' => 'right', 
      'options' => [
        'Right' => 'right', 
    ...
    '3d_effect' => [
      'label' => '3D Effect', 
      'description' => 'Enable a 3D Effect for the flip animation.', 
      'type' => 'checkbox'
    ], 
    'flip_mode' => [
      'label' => 'Flip Mode', 
      'description' => 'Choose the flip mode for mouse and pen events.', 
      'type' => 'select', 
      'default' => 'hover', 
      'options' => [
        'Hover' => 'hover', 
        'Click' => 'click', 
        'Hover and Click' => 'hover, click'
      ]
    ], 
    'flip_mode_touch' => [
      'label' => 'Flip Mode Touch', 
      'description' => 'Choose the flip mode for touch events.', 
      'type' => 'select', 
      'default' => 'tap', 
      'options' => [
        'Tap' => 'tap', 
    ...
    'link_size' => [
      ...
      'enable' => 'link_text && link_style && link_style != \'link-muted\' && link_style != \'link-text\''
    ], 
    'link_fullwidth' => [
      'type' => 'checkbox', 
    ...
    'panel_back_content_padding' => [
      ...
      'show' => '!panel_back_style', 
      'enable' => 'image_back && image_back_align != \'between\''
    ], 
    'panel_back_size' => [
      'label' => 'Padding', 
      'description' => 'Define the card\'s size by selecting the padding between the card and its content.', 
    ...
    'title_back_link' => [
      ...
      'type' => 'checkbox', 
      'text' => 'Link title', 
      'enable' => 'title_back && link_back'
    ], 
    'title_back_hover_style' => [
      'label' => 'Hover Style', 
      ...
      'enable' => 'title_back && link_back && (title_back_link || panel_back_link)'
    ], 
    'title_back_decoration' => [
      'label' => 'Decoration', 
      'description' => 'Decorate the title with a divider, bullet or a line that is vertically centered to the heading.', 
      'type' => 'select', 
      'options' => [
    ...
    'title_back_grid_width' => [
      ...
      'enable' => 'title_back && title_back_align == \'left\''
    ], 
    'title_back_grid_column_gap' => [
      'label' => 'Grid Column Gap', 
      'description' => 'Set the size of the gap between the title and the content.', 
      'type' => 'select', 
      'options' => [
    ...
    'content_back_column_divider' => [
      'description' => 'Show a divider between text columns.', 
      'type' => 'checkbox', 
      'text' => 'Show dividers', 
      'enable' => 'content_back && content_back_column'
    ], 
    'content_back_column_breakpoint' => [
      'label' => 'Columns Breakpoint', 
      'description' => 'Set the device width from which the text columns should apply.', 
      'type' => 'select', 
      'options' => [
    ...
    'image_back_border' => [
      ...
      'enable' => 'image_back && (!panel_back_style || (panel_back_style && (!panel_back_card_image || image_back_align == \'between\')))'
    ], 
    'image_back_box_shadow' => [
      ...
      'enable' => 'image_back && !panel_back_style'
    ], 
    ...
    'image_back_box_decoration_inverse' => [
      'type' => 'checkbox', 
      'text' => 'Inverse style', 
      'enable' => 'image_back && !panel_back_style && $match(image_back_box_decoration, \'^(default|primary|secondary)$\')'
    ], 
    'image_back_link' => [
      'label' => 'Link', 
      ...
      'type' => 'checkbox', 
      'text' => 'Link image', 
      'enable' => 'image_back && link_back'
    ], 
    'image_back_transition' => [
      ...
      'enable' => 'image_back && link_back && (image_back_link || panel_back_link)'
    ], 
    'image_back_hover_box_shadow' => [
      ...
      'enable' => 'link_back && image_back && !panel_back_style && (image_back_link || panel_back_link)'
    ], 
    'icon_back_width' => $config->get('builder.icon_width'), 
    'icon_back_color' => $config->get('builder.icon_color'), 
    'image_back_align' => [
      'label' => 'Alignment', 
      'description' => 'Align the image to the top, left, right or place it between the title and the content.', 
      'type' => 'select', 
      ...
      'enable' => 'image_back || icon_back'
    ], 
    'image_back_grid_width' => [
      'label' => 'Grid Width', 
      'description' => 'Define the width of the image within the grid. Choose between percent and fixed widths or expand columns to the width of their content.', 
      'type' => 'select', 
      'options' => [
      ...
      'enable' => '(image_back || icon_back) && (image_back_align == \'left\' || image_back_align == \'right\')'
    ], 
    'image_back_grid_column_gap' => [
      'label' => 'Grid Column Gap', 
      'description' => 'Set the size of the gap between the image and the content.', 
      'type' => 'select', 
      'options' => [
      ...
      'enable' => '(image_back || icon_back) && (image_back_align == \'left\' || image_back_align == \'right\') && !(panel_back_card_image && panel_back_style)'
    ], 
    'image_back_grid_row_gap' => [
      'label' => 'Grid Row Gap', 
      'description' => 'Set the size of the gap if the grid items stack.', 
      'type' => 'select', 
      'options' => [
    ...
    'image_back_margin' => [
      ...
      'enable' => '(image_back || icon_back) && (image_back_align == \'between\' || (image_back_align == \'bottom\' && !(panel_back_style && panel_back_card_image)))'
    ], 
    ...
    'link_back_style' => [
      ...
      'enable' => 'link_back && link_back_text'
    ], 
    'link_back_size' => [
      'label' => 'Button Size', 
      'description' => 'Set the button size.', 
      ...
      'enable' => 'link_back && link_back_text && link_back_style && link_back_style != \'link-muted\' && link_back_style != \'link-text\''
    ], 
    'link_back_fullwidth' => [
      'type' => 'checkbox', 
      'text' => 'Full width button', 
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => ['title', 'meta', 'content', 'image', [
            ...
            ], 'image_alt', 'icon', 'link_text']
        ], [
          'title' => 'Content Back', 
          'fields' => ['title_back', 'meta_back', 'content_back', 'image_back', [
              'description' => 'Setting just one value preserves the original proportions. The image will be resized and cropped automatically, and where possible, high resolution images will be auto-generated.', 
              'name' => '_image_dimension', 
              'type' => 'grid', 
              'width' => '1-2', 
              'fields' => ['image_back_width', 'image_back_height']
            ], 'image_back_alt', 'icon_back', 'link_back', 'link_back_target', 'link_back_text']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'Animation', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['flip_animation', '3d_effect', 'flip_mode', 'flip_mode_touch']
            ], [
              'label' => 'Panel', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['image_border', 'image_box_shadow', 'image_box_decoration', 'image_box_decoration_inverse', 'icon_width', 'icon_color', 'image_align', 'image_grid_width', 'image_grid_column_gap', 'image_grid_row_gap', 'image_grid_breakpoint', 'image_vertical_align', 'image_margin', 'image_svg_inline', 'image_svg_animate', 'image_svg_color']
            ], [
              'label' => 'Link', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['panel_back_style', 'panel_back_link', 'panel_back_content_padding', 'panel_back_size', 'panel_back_card_image']
            ], [
              'label' => 'Title Back', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['title_back_style', 'title_back_link', 'title_back_hover_style', 'title_back_decoration', 'title_back_font_family', 'title_back_color', 'title_back_element', 'title_back_align', 'title_back_grid_width', 'title_back_grid_column_gap', 'title_back_grid_row_gap', 'title_back_grid_breakpoint', 'title_back_margin']
            ], [
              'label' => 'Meta Back', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['meta_back_style', 'meta_back_color', 'meta_back_align', 'meta_back_element', 'meta_back_margin']
            ], [
              'label' => 'Content Back', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['content_back_style', 'content_back_align', 'content_back_dropcap', 'content_back_column', 'content_back_column_divider', 'content_back_column_breakpoint', 'content_back_margin']
            ], [
              'label' => 'Image Back', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['image_back_border', 'image_back_box_shadow', 'image_back_box_decoration', 'image_back_box_decoration_inverse', 'image_back_link', 'image_back_transition', 'image_back_hover_box_shadow', 'icon_back_width', 'icon_back_color', 'image_back_align', 'image_back_grid_width', 'image_back_grid_column_gap', 'image_back_grid_row_gap', 'image_back_grid_breakpoint', 'image_back_vertical_align', 'image_back_margin', 'image_back_svg_inline', 'image_back_svg_animate', 'image_back_svg_color']
            ], [
              'label' => 'Link Back', 
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['link_back_style', 'link_back_size', 'link_back_fullwidth', 'link_back_margin']
            ], [
              'label' => 'General', 
              'type' => 'group', 
