...
class GoogleMyBusinessLocationMediaQuery extends AbstractQueryType implements HasSourceInterface
{
    ...
    public function name(): string
    {
        ...
        return "googleMyBusinessMedias_{$id}_query";
    }
    ...
    public function config(): array
    {
        return [
            ...
            'fields' => [
                ...
                $this->name() => [
                    'type' => ['listOf' => GoogleMyBusinessMedia::TYPE_NAME],
    ...
    public static function resolve($root, array $args): array
    {
        ...
        try {
            return self::resolveFromCache($source, $args, function () use ($source, $args) {
                return $source->api()->medias($source->businessAccount . '/' . $source->location, [
            ...
            Event::emit('yooessentials.error', [
                'addon' => 'source',
                'action' => 'source-google-my-business-medias-resolve',
                'args' => $args,
                'error' => $e->getMessage(),
                'exception' => $e
            ]);
    ...
    {
        return 'google-my-business-medias';
    }
}
