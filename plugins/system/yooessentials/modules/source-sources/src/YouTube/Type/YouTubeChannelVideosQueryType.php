...
class YouTubeChannelVideosQueryType extends AbstractQueryType implements HasSourceInterface
{
    ...
    public function name(): string
    {
        ...
        return "youtubeChannelVideos_{$id}_query";
    }
    ...
    public static function resolve($root, array $args)
    {
        ...
        try {
            return self::resolveFromCache($source, $args, function () use ($source, $args) {
                ...
                $result = (array) $source->api()->channelVideos($source->channel, compact('maxResults'));
