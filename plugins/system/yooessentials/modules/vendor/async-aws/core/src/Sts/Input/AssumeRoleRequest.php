...
final class AssumeRoleRequest extends \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Input
{
    /**
    ...
    public function __construct(array $input = [])
    {
        ...
        $this->tags = isset($input['Tags']) ? \array_map([\ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Sts\ValueObject\Tag::class, 'create'], $input['Tags']) : null;
