...
namespace ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Test\Http;
 ...
 * @final
 */
class SimpleMockedResponse extends \ZOOlanders\YOOessentials\Vendor\Symfony\Component\HttpClient\Response\MockResponse
{
    private $headers = [];
    private $content = '';
    private $statusCode;
    ...
    public function __construct(string $content = '', array $headers = [], int $statusCode = 200)
    {
        ...
        parent::__construct($content, ['response_headers' => $this->getFlatHeaders(), 'http_code' => $statusCode]);
    }
    ...
    {
        return \json_decode($this->getContent($throw), \true);
    }
    public function cancel() : void
    {
        throw new \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Exception\LogicException('Not implemented');
    }
