 ...
 */
class AssumeRoleWithWebIdentityResponse extends \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Result
{
    /**
    ...
    public function getAssumedRoleUser() : ?\ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Sts\ValueObject\AssumedRoleUser
    {
        $this->initialize();
    ...
    public function getCredentials() : ?\ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Sts\ValueObject\Credentials
    {
        $this->initialize();
    ...
    protected function populateResult(\ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Response $response) : void
    {
        ...
        $this->credentials = !$data->Credentials ? null : new \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Sts\ValueObject\Credentials(['AccessKeyId' => (string) $data->Credentials->AccessKeyId, 'SecretAccessKey' => (string) $data->Credentials->SecretAccessKey, 'SessionToken' => (string) $data->Credentials->SessionToken, 'Expiration' => new \DateTimeImmutable((string) $data->Credentials->Expiration)]);
        $this->subjectFromWebIdentityToken = ($v = $data->SubjectFromWebIdentityToken) ? (string) $v : null;
        $this->assumedRoleUser = !$data->AssumedRoleUser ? null : new \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Sts\ValueObject\AssumedRoleUser(['AssumedRoleId' => (string) $data->AssumedRoleUser->AssumedRoleId, 'Arn' => (string) $data->AssumedRoleUser->Arn]);
