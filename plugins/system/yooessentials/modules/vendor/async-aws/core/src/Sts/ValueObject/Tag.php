...
final class Tag
{
    ...
    public function requestBody() : array
    {
        ...
        if (null === ($v = $this->value)) {
            throw new \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Exception\InvalidArgument(\sprintf('Missing parameter "Value" for "%s". The value cannot be null.', __CLASS__));
        }
        $payload['Value'] = $v;
        return $payload;
    }
