...
class Result
{
    ...
    public function __construct(\ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Response $response, \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\AbstractApi $awsClient = null, $request = null)
    {
    ...
    public static final function wait(iterable $results, float $timeout = null, bool $downloadBody = \false) : iterable
    {
        ...
        foreach (\ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Response::wait($responses, $timeout, $downloadBody) as $index => $response) {
