 ...
 * @internal
 */
final class RewindableStream implements \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Stream\RequestStream
{
    private $content;
    /**
     * @var RequestStream
     */
    private $fallback;
    private function __construct(\ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Stream\RequestStream $content)
    {
        $this->content = $content;
    }
    public static function create(\ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Stream\RequestStream $content) : \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Stream\RewindableStream
    {
    ...
    public function getIterator() : \Traversable
    {
        ...
        $this->fallback = \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Stream\ResourceStream::create($resource);
