...
final class DeleteObjectsRequest extends \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Input
{
    /**
    ...
    public function __construct(array $input = [])
    {
        ...
        $this->delete = isset($input['Delete']) ? \ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\Delete::create($input['Delete']) : null;
    ...
    public function getDelete() : ?\ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\Delete
    {
        return $this->delete;
    }
    ...
    public function setDelete(?\ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\Delete $value) : self
    {
        $this->delete = $value;
        return $this;
    }
    ...
    private function requestBody(\DOMNode $node, \DOMDocument $document) : void
    {
        if (null === ($v = $this->delete)) {
            throw new \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Exception\InvalidArgument(\sprintf('Missing parameter "Delete" for "%s". The value cannot be null.', __CLASS__));
        }
