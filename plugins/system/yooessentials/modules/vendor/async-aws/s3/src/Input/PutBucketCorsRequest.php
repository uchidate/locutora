...
final class PutBucketCorsRequest extends \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Input
{
    /**
    ...
    public function __construct(array $input = [])
    {
        ...
        $this->corsConfiguration = isset($input['CORSConfiguration']) ? \ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\CORSConfiguration::create($input['CORSConfiguration']) : null;
    ...
    public function getCorsConfiguration() : ?\ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\CORSConfiguration
    {
    ...
    public function setCorsConfiguration(?\ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\ValueObject\CORSConfiguration $value) : self
    {
    ...
    private function requestBody(\DOMNode $node, \DOMDocument $document) : void
    {
        if (null === ($v = $this->corsConfiguration)) {
            throw new \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Exception\InvalidArgument(\sprintf('Missing parameter "CORSConfiguration" for "%s". The value cannot be null.', __CLASS__));
        }
