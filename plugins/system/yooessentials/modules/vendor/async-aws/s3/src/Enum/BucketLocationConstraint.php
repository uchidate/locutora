...
final class BucketLocationConstraint
{
    ...
    {
        return isset([self::AF_SOUTH_1 => \true, self::AP_EAST_1 => \true, self::AP_NORTHEAST_1 => \true, self::AP_NORTHEAST_2 => \true, self::AP_NORTHEAST_3 => \true, self::AP_SOUTHEAST_1 => \true, self::AP_SOUTHEAST_2 => \true, self::AP_SOUTH_1 => \true, self::CA_CENTRAL_1 => \true, self::CN_NORTHWEST_1 => \true, self::CN_NORTH_1 => \true, self::EU => \true, self::EU_CENTRAL_1 => \true, self::EU_NORTH_1 => \true, self::EU_SOUTH_1 => \true, self::EU_WEST_1 => \true, self::EU_WEST_2 => \true, self::EU_WEST_3 => \true, self::ME_SOUTH_1 => \true, self::SA_EAST_1 => \true, self::US_EAST_2 => \true, self::US_GOV_EAST_1 => \true, self::US_GOV_WEST_1 => \true, self::US_WEST_1 => \true, self::US_WEST_2 => \true][$value]);
    }
}
