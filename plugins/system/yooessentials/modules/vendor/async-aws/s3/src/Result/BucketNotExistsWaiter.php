...
class BucketNotExistsWaiter extends \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Waiter
{
    ...
    protected function refreshState() : \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Waiter
    {
        ...
        if (!$this->input instanceof \ZOOlanders\YOOessentials\Vendor\AsyncAws\S3\Input\HeadBucketRequest) {
