...
final class TopicConfiguration
{
    ...
    public function requestBody(\DOMElement $node, \DOMDocument $document) : void
    {
        ...
        if (null === ($v = $this->topicArn)) {
            throw new \ZOOlanders\YOOessentials\Vendor\AsyncAws\Core\Exception\InvalidArgument(\sprintf('Missing parameter "TopicArn" for "%s". The value cannot be null.', __CLASS__));
        }
