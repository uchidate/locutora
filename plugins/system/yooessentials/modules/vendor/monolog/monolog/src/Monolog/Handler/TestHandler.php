 ...
 */
class TestHandler extends \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var Record[] */
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\ZOOlanders\YOOessentials\Vendor\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
