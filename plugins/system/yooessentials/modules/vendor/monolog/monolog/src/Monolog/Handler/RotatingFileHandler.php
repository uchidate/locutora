 ...
 */
class RotatingFileHandler extends \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \ZOOlanders\YOOessentials\Vendor\Monolog\Utils::canonicalizePath($filename);
