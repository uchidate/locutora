 ...
 */
class LineFormatter extends \ZOOlanders\YOOessentials\Vendor\Monolog\Formatter\NormalizerFormatter
{
    ...
    public function format(array $record) : string
    {
        ...
        if (\false !== \strpos($output, '%')) {
            ...
            if (null === $output) {
                ...
                throw new \RuntimeException('Failed to run preg_replace: ' . $pcreErrorCode . ' / ' . \ZOOlanders\YOOessentials\Vendor\Monolog\Utils::pcreLastErrorMessage($pcreErrorCode));
            }
        }
        return $output;
    }
    ...
    {
        $str = '[object] (' . \ZOOlanders\YOOessentials\Vendor\Monolog\Utils::getClass($e) . '(code: ' . $e->getCode();
