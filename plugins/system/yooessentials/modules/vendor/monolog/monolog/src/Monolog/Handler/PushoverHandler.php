 ...
 */
class PushoverHandler extends \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\SocketHandler
{
    /** @var string */
    private $token;
     ...
     */
    public function __construct(string $token, $users, ?string $title = null, $level = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::CRITICAL, bool $bubble = \true, bool $useSSL = \true, $highPriorityLevel = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::CRITICAL, $emergencyLevel = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::EMERGENCY, int $retry = 30, int $expire = 25200, bool $persistent = \false, float $timeout = 0.0, float $writingTimeout = 10.0, ?float $connectionTimeout = null, ?int $chunkSize = null)
    {
        ...
        $this->highPriorityLevel = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
    ...
    private function buildContent(array $record) : string
    {
        ...
        $message = \ZOOlanders\YOOessentials\Vendor\Monolog\Utils::substr($message, 0, $maxMessageLength);
    ...
    {
        $this->highPriorityLevel = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    /**
     * @param int|string $value
    ...
    {
        $this->emergencyLevel = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    /**
