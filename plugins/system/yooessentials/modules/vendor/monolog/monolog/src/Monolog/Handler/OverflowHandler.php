 ...
 */
class OverflowHandler extends \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\AbstractHandler implements \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\ZOOlanders\YOOessentials\Vendor\Monolog\Logger::DEBUG => 0, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::INFO => 0, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::NOTICE => 0, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::WARNING => 0, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::ERROR => 0, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::CRITICAL => 0, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::ALERT => 0, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     */
    public function __construct(\ZOOlanders\YOOessentials\Vendor\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
