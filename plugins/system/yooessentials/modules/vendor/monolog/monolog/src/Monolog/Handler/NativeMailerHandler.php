 ...
 */
class NativeMailerHandler extends \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\MailHandler
{
    /**
     ...
     */
    public function __construct($to, string $subject, string $from, $level = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::ERROR, bool $bubble = \true, int $maxColumnWidth = 70)
    {
    ...
    protected function send(string $content, array $records) : void
    {
        ...
        if ($records) {
            $subjectFormatter = new \ZOOlanders\YOOessentials\Vendor\Monolog\Formatter\LineFormatter($this->subject);
