 ...
 */
abstract class AbstractSyslogHandler extends \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var int */
    protected $facility;
    /**
     ...
     */
    protected $logLevels = [\ZOOlanders\YOOessentials\Vendor\Monolog\Logger::DEBUG => \LOG_DEBUG, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::INFO => \LOG_INFO, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::NOTICE => \LOG_NOTICE, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::WARNING => \LOG_WARNING, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::ERROR => \LOG_ERR, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::CRITICAL => \LOG_CRIT, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::ALERT => \LOG_ALERT, \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::EMERGENCY => \LOG_EMERG];
    /**
     ...
     */
    public function __construct($facility = \LOG_USER, $level = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    {
        return new \ZOOlanders\YOOessentials\Vendor\Monolog\Formatter\LineFormatter('%channel%.%level_name%: %message% %context% %extra%');
    }
}
