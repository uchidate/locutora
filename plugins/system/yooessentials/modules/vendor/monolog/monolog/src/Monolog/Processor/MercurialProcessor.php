 ...
 */
class MercurialProcessor implements \ZOOlanders\YOOessentials\Vendor\Monolog\Processor\ProcessorInterface
{
    /** @var Level */
    private $level;
     ...
     */
    public function __construct($level = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::DEBUG)
    {
