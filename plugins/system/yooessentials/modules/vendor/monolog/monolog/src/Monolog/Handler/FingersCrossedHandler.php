...
use ZOOlanders\YOOessentials\Vendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use ZOOlanders\YOOessentials\Vendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
...
class FingersCrossedHandler extends \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\Handler implements \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\ProcessableHandlerInterface, \ZOOlanders\YOOessentials\Vendor\Monolog\ResettableInterface, \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\FormattableHandlerInterface
{
    ...
    public function __construct($handler, $activationStrategy = null, int $bufferSize = 0, bool $bubble = \true, bool $stopBuffering = \true, $passthruLevel = null)
    {
        if (null === $activationStrategy) {
            $activationStrategy = new \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy(\ZOOlanders\YOOessentials\Vendor\Monolog\Logger::WARNING);
        }
        // convert simple int activationStrategy to an object
        if (!$activationStrategy instanceof \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface) {
            $activationStrategy = new \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy($activationStrategy);
        }
        ...
        if ($passthruLevel !== null) {
            $this->passthruLevel = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::toMonologLevel($passthruLevel);
        }
