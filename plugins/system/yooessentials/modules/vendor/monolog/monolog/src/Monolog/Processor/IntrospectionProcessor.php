 ...
 */
class IntrospectionProcessor implements \ZOOlanders\YOOessentials\Vendor\Monolog\Processor\ProcessorInterface
{
    /** @var int */
    private $level;
    /** @var string[] */
     ...
     */
    public function __construct($level = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::DEBUG, array $skipClassesPartials = [], int $skipStackFramesCount = 0)
    {
        $this->level = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::toMonologLevel($level);
