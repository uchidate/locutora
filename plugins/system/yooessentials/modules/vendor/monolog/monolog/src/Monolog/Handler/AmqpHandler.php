...
use ZOOlanders\YOOessentials\Vendor\Monolog\Formatter\JsonFormatter;
use ZOOlanders\YOOessentials\Vendor\PhpAmqpLib\Message\AMQPMessage;
use ZOOlanders\YOOessentials\Vendor\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
/**
 * @phpstan-import-type Record from \Monolog\Logger
 */
class AmqpHandler extends \ZOOlanders\YOOessentials\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($exchange, ?string $exchangeName = null, $level = \ZOOlanders\YOOessentials\Vendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
        if ($exchange instanceof \ZOOlanders\YOOessentials\Vendor\PhpAmqpLib\Channel\AMQPChannel) {
    ...
    private function createAmqpMessage(string $data) : \ZOOlanders\YOOessentials\Vendor\PhpAmqpLib\Message\AMQPMessage
    {
        return new \ZOOlanders\YOOessentials\Vendor\PhpAmqpLib\Message\AMQPMessage($data, ['delivery_mode' => 2, 'content_type' => 'application/json']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return new \ZOOlanders\YOOessentials\Vendor\Monolog\Formatter\JsonFormatter(\ZOOlanders\YOOessentials\Vendor\Monolog\Formatter\JsonFormatter::BATCH_MODE_JSON, \false);
    }
}
