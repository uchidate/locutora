 ...
 * @internal
 */
class CurlRequest implements \ZOOlanders\YOOessentials\Vendor\MaxMind\WebService\Http\Request
{
    /**
     * @var \CurlHandle
     */
    ...
    private function execute($curl) : array
    {
        ...
        if ($errno = \curl_errno($curl)) {
            ...
            throw new \ZOOlanders\YOOessentials\Vendor\MaxMind\Exception\HttpException("cURL error ({$errno}): {$errorMessage}", 0, $this->url);
        }
