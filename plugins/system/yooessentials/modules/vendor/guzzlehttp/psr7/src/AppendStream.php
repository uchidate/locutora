 ...
 */
final class AppendStream implements \ZOOlanders\YOOessentials\Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\ZOOlanders\YOOessentials\Vendor\Psr\Http\Message\StreamInterface $stream) : void
    {
    ...
    {
        return \ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
