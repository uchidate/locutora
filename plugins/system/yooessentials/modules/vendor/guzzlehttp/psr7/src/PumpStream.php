 ...
 */
final class PumpStream implements \ZOOlanders\YOOessentials\Vendor\Psr\Http\Message\StreamInterface
{
    /** @var callable|null */
    private $source;
    /** @var int|null */
    ...
    public function __construct(callable $source, array $options = [])
    {
        ...
        $this->buffer = new \ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\BufferStream();
    }
