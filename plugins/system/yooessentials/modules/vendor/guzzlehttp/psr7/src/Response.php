 ...
 */
class Response implements \ZOOlanders\YOOessentials\Vendor\Psr\Http\Message\ResponseInterface
{
    use MessageTrait;
    ...
    public function withStatus($code, $reasonPhrase = '') : \ZOOlanders\YOOessentials\Vendor\Psr\Http\Message\ResponseInterface
    {
