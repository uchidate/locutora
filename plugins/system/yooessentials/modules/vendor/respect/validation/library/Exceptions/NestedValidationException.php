 ...
 */
class NestedValidationException extends \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Exceptions\ValidationException implements \IteratorAggregate
{
    /**
     ...
     */
    public function addChild(\ZOOlanders\YOOessentials\Vendor\Respect\Validation\Exceptions\ValidationException $exception) : self
    {
    ...
    {
        return new \RecursiveIteratorIterator(new \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Exceptions\RecursiveExceptionIterator($this), \RecursiveIteratorIterator::SELF_FIRST);
    }
    private function isOmissible(\ZOOlanders\YOOessentials\Vendor\Respect\Validation\Exceptions\Exception $exception) : bool
    {
        if (!$exception instanceof self) {
            return \false;
        }
        ...
        return !$childException instanceof \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Exceptions\NonOmissibleException;
    }
    /**
     * @param string[]|string[][] $templates
     */
    private function renderMessage(\ZOOlanders\YOOessentials\Vendor\Respect\Validation\Exceptions\ValidationException $exception, array $templates) : string
    {
