 ...
 */
class ValidationException extends \InvalidArgumentException implements \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Exceptions\Exception
{
     ...
     * @param mixed[] $params
     */
    public function __construct($input, string $id, array $params, \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Message\Formatter $formatter)
    {
        $this->input = $input;
        $this->id = $id;
        $this->params = $params;
