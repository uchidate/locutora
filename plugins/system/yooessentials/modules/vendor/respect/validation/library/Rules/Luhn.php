 ...
 */
final class Luhn extends \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Rules\AbstractRule
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        if (!(new \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Rules\Digit())->validate($input)) {
            return \false;
        }
