 ...
 */
final class SubdivisionCode extends \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Rules\AbstractSearcher
{
    /**
     * @var string
     */
    ...
    {
        $subdivisions = new \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Helpers\Subdivisions($countryCode);
