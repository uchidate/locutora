 ...
 */
final class Ip extends \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Rules\AbstractRule
{
    /**
     * @var string|null
     */
    ...
    private function parseRange(string $input) : void
    {
        ...
        if (\mb_strpos($input, '-') !== \false) {
            ...
            if ($this->startAddress !== null && !$this->verifyAddress($this->startAddress)) {
                throw new \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Exceptions\ComponentException('Invalid network range');
            }
    ...
    private function parseRangeUsingCidr(string $input) : void
    {
        ...
        if ($isAddressMask || $parts[1] < 8 || $parts[1] > 30) {
            throw new \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Exceptions\ComponentException('Invalid network mask');
        }
