 ...
 */
final class KeyNested extends \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Rules\AbstractRelated
{
    /**
     * {@inheritDoc}
     */
    public function hasReference($input) : bool
    {
        ...
        } catch (\ZOOlanders\YOOessentials\Vendor\Respect\Validation\Exceptions\ComponentException $cex) {
            return \false;
        }
        return \true;
    }
    ...
    public function getReferenceValue($input)
    {
        if (\is_scalar($input)) {
            ...
            throw new \ZOOlanders\YOOessentials\Vendor\Respect\Validation\Exceptions\ComponentException($message);
        }
