...
@\trigger_error(\sprintf('%s is deprecated; use %s instead', \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Extension\HeadingPermalink\Slug\DefaultSlugGenerator::class, \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Normalizer\SlugNormalizer::class), \E_USER_DEPRECATED);
/**
 * Creates URL-friendly strings
 *
 * @deprecated Use League\CommonMark\Normalizer\SlugNormalizer instead
 */
final class DefaultSlugGenerator implements \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Extension\HeadingPermalink\Slug\SlugGeneratorInterface
{
