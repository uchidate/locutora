...
final class RegexHelper
{
    ...
    public static function unescape(string $string) : string
    {
        ...
        $replaced = \preg_replace_callback('/' . self::PARTIAL_ENTITY . '/i', function ($e) {
            return \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Util\Html5EntityDecoder::decode($e[0]);
        }, $escaped);
        return $replaced;
    }
    /**
    ...
    {
        switch ($type) {
            case \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Block\Element\HtmlBlock::TYPE_1_CODE_CONTAINER:
                return '/^<(?:script|pre|textarea|style)(?:\\s|>|$)/i';
            case \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Block\Element\HtmlBlock::TYPE_2_COMMENT:
                return '/^<!--/';
            case \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Block\Element\HtmlBlock::TYPE_3:
                return '/^<[?]/';
            case \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Block\Element\HtmlBlock::TYPE_4:
                return '/^<![A-Z]/';
            case \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Block\Element\HtmlBlock::TYPE_5_CDATA:
                return '/^<!\\[CDATA\\[/';
            case \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Block\Element\HtmlBlock::TYPE_6_BLOCK_ELEMENT:
            ...
            case \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Block\Element\HtmlBlock::TYPE_7_MISC_ELEMENT:
