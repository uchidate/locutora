...
final class TableCellRenderer implements \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Block\Renderer\BlockRendererInterface
{
    ...
    {
        if (!$block instanceof \ZOOlanders\YOOessentials\Vendor\League\CommonMark\Extension\Table\TableCell) {
        ...
        return new \ZOOlanders\YOOessentials\Vendor\League\CommonMark\HtmlElement($block->type, $attrs, $htmlRenderer->renderInlines($block->children()));
    }
}
