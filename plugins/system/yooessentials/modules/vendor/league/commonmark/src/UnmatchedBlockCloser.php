...
class UnmatchedBlockCloser
{
     ...
     */
    public function __construct(\ZOOlanders\YOOessentials\Vendor\League\CommonMark\ContextInterface $context)
    {
     ...
     * @return void
     */
    public function setLastMatchedContainer(\ZOOlanders\YOOessentials\Vendor\League\CommonMark\Block\Element\AbstractBlock $block)
    {
