...
use finfo;
class FinfoMimeTypeDetector implements \ZOOlanders\YOOessentials\Vendor\League\MimeTypeDetection\MimeTypeDetector
{
    ...
    public function __construct(string $magicFile = '', \ZOOlanders\YOOessentials\Vendor\League\MimeTypeDetection\ExtensionToMimeTypeMap $extensionMap = null, ?int $bufferSampleSize = null, array $inconclusiveMimetypes = self::INCONCLUSIVE_MIME_TYPES)
    {
        $this->finfo = new \finfo(\FILEINFO_MIME_TYPE, $magicFile);
        $this->extensionMap = $extensionMap ?: new \ZOOlanders\YOOessentials\Vendor\League\MimeTypeDetection\GeneratedExtensionToMimeTypeMap();
