...
class PortableVisibilityConverter implements \ZOOlanders\YOOessentials\Vendor\League\Flysystem\AsyncAwsS3\VisibilityConverter
{
    ...
    public function __construct(string $defaultForDirectories = \ZOOlanders\YOOessentials\Vendor\League\Flysystem\Visibility::PUBLIC)
    {
        $this->defaultForDirectories = $defaultForDirectories;
    }
    public function visibilityToAcl(string $visibility) : string
    {
        if (\ZOOlanders\YOOessentials\Vendor\League\Flysystem\Visibility::PUBLIC === $visibility) {
