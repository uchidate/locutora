...
use ZOOlanders\YOOessentials\Vendor\League\Csv\Polyfill\EmptyEscapeParser;
use SplFileObject;
 ...
 */
class Reader extends \ZOOlanders\YOOessentials\Vendor\League\Csv\AbstractCsv implements \ZOOlanders\YOOessentials\Vendor\League\Csv\TabularDataReader, \JsonSerializable
{
    /**
     * header offset.
     *
    ...
    protected function setHeader(int $offset) : array
    {
        ...
        if (\in_array($header, [[], [null]], \true)) {
            throw new \ZOOlanders\YOOessentials\Vendor\League\Csv\SyntaxError(\sprintf('The header record does not exist or is empty at offset: `%s`', $offset));
        }
        if (0 !== $offset) {
            return $header;
        }
    ...
    protected function getDocument() : \Iterator
    {
        if (70400 > \PHP_VERSION_ID && '' === $this->escape) {
            ...
            return \ZOOlanders\YOOessentials\Vendor\League\Csv\Polyfill\EmptyEscapeParser::parse($this->document);
        }
    ...
    {
        return \ZOOlanders\YOOessentials\Vendor\League\Csv\ResultSet::createFromTabularDataReader($this)->fetchColumn($index);
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \ZOOlanders\YOOessentials\Vendor\League\Csv\ResultSet::createFromTabularDataReader($this)->fetchOne($nth_record);
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \ZOOlanders\YOOessentials\Vendor\League\Csv\ResultSet::createFromTabularDataReader($this)->fetchPairs($offset_index, $value_index);
    }
    /**
     * {@inheritdoc}
     */
    ...
    public function getRecords(array $header = []) : \Iterator
    {
        ...
        if ($this->is_empty_records_included) {
            ...
            return $this->combineHeader(new \ZOOlanders\YOOessentials\Vendor\League\Csv\MapIterator($records, $normalized_empty_records), $header);
        }
    ...
    protected function computeHeader(array $header)
    {
        ...
        throw new \ZOOlanders\YOOessentials\Vendor\League\Csv\SyntaxError('The header record must be an empty or a flat array with unique string values.');
    }
    /**
    ...
    protected function combineHeader(\Iterator $iterator, array $header) : \Iterator
    {
        ...
        return new \ZOOlanders\YOOessentials\Vendor\League\Csv\MapIterator($iterator, $mapper);
    }
    /**
    ...
    protected function stripBOM(\Iterator $iterator, string $bom) : \Iterator
    {
        ...
        return new \CallbackFilterIterator(new \ZOOlanders\YOOessentials\Vendor\League\Csv\MapIterator($iterator, $mapper), $filter);
    }
    /**
    ...
    public function setHeaderOffset(?int $offset) : self
    {
        ...
        if (null !== $offset && 0 > $offset) {
            throw new \ZOOlanders\YOOessentials\Vendor\League\Csv\InvalidArgument(__METHOD__ . '() expects 1 Argument to be greater or equal to 0');
        }
