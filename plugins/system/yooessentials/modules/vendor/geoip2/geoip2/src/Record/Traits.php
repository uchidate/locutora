 ...
 * </p>
 */
class Traits extends \ZOOlanders\YOOessentials\Vendor\GeoIp2\Record\AbstractRecord
{
    /**
     * @ignore
     *
    ...
    public function __construct(?array $record)
    {
        if (!isset($record['network']) && isset($record['ip_address'], $record['prefix_len'])) {
            $record['network'] = \ZOOlanders\YOOessentials\Vendor\GeoIp2\Util::cidr($record['ip_address'], $record['prefix_len']);
        }
