...
abstract class Base
{
     ...
     * @return object
     */
    public function convertInteger(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $x)
    {
    ...
    public function createRandomMultiplier()
    {
        ...
        return \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger::randomRange($one, $this->order->subtract($one));
    }
    /**
     ...
     * Sets the Order
     */
    public function setOrder(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $order)
    {
        $this->order = $order;
    }
    /**
