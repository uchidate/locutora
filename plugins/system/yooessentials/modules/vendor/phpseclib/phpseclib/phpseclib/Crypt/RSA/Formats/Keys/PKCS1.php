...
abstract class PKCS1 extends \ZOOlanders\YOOessentials\Vendor\phpseclib3\Crypt\Common\Formats\Keys\PKCS1
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $key = \ZOOlanders\YOOessentials\Vendor\phpseclib3\File\ASN1::asn1map($decoded[0], \ZOOlanders\YOOessentials\Vendor\phpseclib3\File\ASN1\Maps\RSAPrivateKey::MAP);
        if (\is_array($key)) {
        ...
        $key = \ZOOlanders\YOOessentials\Vendor\phpseclib3\File\ASN1::asn1map($decoded[0], \ZOOlanders\YOOessentials\Vendor\phpseclib3\File\ASN1\Maps\RSAPublicKey::MAP);
        if (!\is_array($key)) {
    ...
    public static function savePrivateKey(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $n, \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $e, \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $d, array $primes, array $exponents, array $coefficients, $password = '', array $options = [])
    {
        ...
        $key = \ZOOlanders\YOOessentials\Vendor\phpseclib3\File\ASN1::encodeDER($key, \ZOOlanders\YOOessentials\Vendor\phpseclib3\File\ASN1\Maps\RSAPrivateKey::MAP);
    ...
    public static function savePublicKey(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $n, \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $e)
    {
        ...
        $key = \ZOOlanders\YOOessentials\Vendor\phpseclib3\File\ASN1::encodeDER($key, \ZOOlanders\YOOessentials\Vendor\phpseclib3\File\ASN1\Maps\RSAPublicKey::MAP);
