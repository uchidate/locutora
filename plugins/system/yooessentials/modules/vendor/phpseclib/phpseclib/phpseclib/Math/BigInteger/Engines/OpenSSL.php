...
use ZOOlanders\YOOessentials\Vendor\phpseclib3\Crypt\RSA\Formats\Keys\PKCS8;
...
abstract class OpenSSL
{
     ...
     * @return Engine
     */
    public static function powModHelper(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger\Engines\Engine $x, \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger\Engines\Engine $e, \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger\Engines\Engine $n)
    {
        ...
        $key = \ZOOlanders\YOOessentials\Vendor\phpseclib3\Crypt\RSA\Formats\Keys\PKCS8::savePublicKey(new \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger($n), new \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger($e));
