...
{
    const MAP = [
        'type' => \ZOOlanders\YOOessentials\Vendor\phpseclib3\File\ASN1::TYPE_SET,
        'min' => 1,
        'max' => 256,
        // ub-extension-attributes
        'children' => \ZOOlanders\YOOessentials\Vendor\phpseclib3\File\ASN1\Maps\ExtensionAttribute::MAP,
    ];
}
