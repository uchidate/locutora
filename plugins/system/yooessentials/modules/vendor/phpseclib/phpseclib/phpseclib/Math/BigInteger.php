 ...
 */
namespace ZOOlanders\YOOessentials\Vendor\phpseclib3\Math;

use ZOOlanders\YOOessentials\Vendor\phpseclib3\Exception\BadConfigurationException;
use ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger\Engines\Engine;
/**
...
class BigInteger implements \JsonSerializable
{
    ...
    public static function setEngine($main, array $modexps = ['DefaultEngine'])
    {
        ...
        if (!$fqmain::isValidEngine()) {
            throw new \ZOOlanders\YOOessentials\Vendor\phpseclib3\Exception\BadConfigurationException("{$main} is not setup correctly on this system");
        }
        ...
        if (!$found) {
            throw new \ZOOlanders\YOOessentials\Vendor\phpseclib3\Exception\BadConfigurationException("No valid modular exponentiation engine found for {$main}");
        }
    ...
    public function __construct($x = 0, $base = 10)
    {
        ...
        if ($x instanceof self::$mainEngine) {
            $this->value = clone $x;
        } elseif ($x instanceof \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger\Engines\Engine) {
     ...
     * @return BigInteger
     */
    public function add(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function subtract(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function multiply(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger[]
     */
    public function divide(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function modInverse(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger[]
     */
    public function extendedGCD(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function gcd(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function powMod(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $e, \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function modPow(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $e, \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @see self::equals()
     */
    public function compare(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return bool
     */
    public function equals(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_and(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_or(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_xor(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     */
    public static function randomRangePrime(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $min, \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function randomRange(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $min, \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public function pow(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public static function min(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function max(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
        $nums = \array_map(function ($num) {
            return $num->value;
     ...
     * @return bool
     */
    public function between(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $min, \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $max)
    {
     ...
     * @return int
     */
    public static function scan1divide(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $r)
    {
        $class = self::$mainEngine;
    ...
    public function createRecurringModuloFunction()
    {
        ...
        return function (\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $x) use($func) {
