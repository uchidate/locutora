 ...
 */
namespace ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\PrimeField;
...
use ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\Common\FiniteField\Integer as Base;
/**
 * Prime Finite Fields
 *
 * @author  Jim Wigginton <terrafrost@php.net>
 */
class Integer extends \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\Common\FiniteField\Integer
{
    /**
     ...
     */
    public function __construct($instanceID, \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $num = null)
    {
     ...
     * @return void
     */
    public static function setModulo($instanceID, \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $modulo)
    {
    ...
    public static function setRecurringModuloFunction($instanceID, callable $function)
    {
        ...
        if (!isset(static::$zero[static::class])) {
            static::$zero[static::class] = new \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger();
        }
    }
    /**
     ...
     * @return static
     */
    public function pow(\ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger $x)
    {
        $temp = new static($this->instanceID);
    ...
    public function squareRoot()
    {
        ...
        $q = clone $p_1;
        $s = \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger::scan1divide($q);
        ...
        $m = new \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger($s);
    ...
    {
        return \ZOOlanders\YOOessentials\Vendor\phpseclib3\Common\Functions\Strings::bin2hex($this->toBytes());
    }
    /**
    ...
    {
        $w++;
        $mask = new \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger((1 << $w) - 1);
        $sub = new \ZOOlanders\YOOessentials\Vendor\phpseclib3\Math\BigInteger(1 << $w);
