 ...
 * @author  Jim Wigginton <terrafrost@php.net>
 */
class DES extends \ZOOlanders\YOOessentials\Vendor\phpseclib3\Crypt\Common\BlockCipher
{
    /**
    ...
    {
        if (!$this instanceof \ZOOlanders\YOOessentials\Vendor\phpseclib3\Crypt\TripleDES && \strlen($key) != 8) {
