...
use ZOOlanders\YOOessentials\Vendor\Google\Auth\Credentials\InsecureCredentials;
 ...
 */
abstract class CredentialsLoader implements \ZOOlanders\YOOessentials\Vendor\Google\Auth\FetchAuthTokenInterface, \ZOOlanders\YOOessentials\Vendor\Google\Auth\UpdateMetadataInterface
{
    ...
    public static function makeCredentials($scope, array $jsonKey, $defaultScope = null)
    {
        ...
        if ($jsonKey['type'] == 'service_account') {
            ...
            return new \ZOOlanders\YOOessentials\Vendor\Google\Auth\Credentials\ServiceAccountCredentials($scope, $jsonKey);
        }
        if ($jsonKey['type'] == 'authorized_user') {
            $anyScope = $scope ?: $defaultScope;
            return new \ZOOlanders\YOOessentials\Vendor\Google\Auth\Credentials\UserRefreshCredentials($anyScope, $jsonKey);
        }
     ...
     */
    public static function makeHttpClient(\ZOOlanders\YOOessentials\Vendor\Google\Auth\FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], callable $httpHandler = null, callable $tokenCallback = null)
    {
        $middleware = new \ZOOlanders\YOOessentials\Vendor\Google\Auth\Middleware\AuthTokenMiddleware($fetcher, $httpHandler, $tokenCallback);
        $stack = \ZOOlanders\YOOessentials\Vendor\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);
        return new \ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**
    ...
    {
        return new \ZOOlanders\YOOessentials\Vendor\Google\Auth\Credentials\InsecureCredentials();
    }
    /**
