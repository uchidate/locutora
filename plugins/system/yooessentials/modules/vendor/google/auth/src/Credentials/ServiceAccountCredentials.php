...
use ZOOlanders\YOOessentials\Vendor\Google\Auth\ServiceAccountSignerTrait;
 ...
 */
class ServiceAccountCredentials extends \ZOOlanders\YOOessentials\Vendor\Google\Auth\CredentialsLoader implements \ZOOlanders\YOOessentials\Vendor\Google\Auth\GetQuotaProjectInterface, \ZOOlanders\YOOessentials\Vendor\Google\Auth\SignBlobInterface, \ZOOlanders\YOOessentials\Vendor\Google\Auth\ProjectIdProviderInterface
{
    ...
    public function __construct($scope, $jsonKey, $sub = null, $targetAudience = null)
    {
        ...
        $this->auth = new \ZOOlanders\YOOessentials\Vendor\Google\Auth\OAuth2(['audience' => self::TOKEN_CREDENTIAL_URI, 'issuer' => $jsonKey['client_email'], 'scope' => $scope, 'signingAlgorithm' => 'RS256', 'signingKey' => $jsonKey['private_key'], 'sub' => $sub, 'tokenCredentialUri' => self::TOKEN_CREDENTIAL_URI, 'additionalClaims' => $additionalClaims]);
    ...
    private function createJwtAccessCredentials()
    {
        if (!$this->jwtAccessCredentials) {
            ...
            $this->jwtAccessCredentials = new \ZOOlanders\YOOessentials\Vendor\Google\Auth\Credentials\ServiceAccountJwtAccessCredentials($credJson, $this->auth->getScope());
        }
