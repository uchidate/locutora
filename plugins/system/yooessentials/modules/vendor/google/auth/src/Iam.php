...
class Iam
{
    ...
    public function signBlob($email, $accessToken, $stringToSign, array $delegates = [])
    {
        ...
        $request = new \ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\Request('POST', $uri, $headers, \ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\Utils::streamFor(\json_encode($body)));
