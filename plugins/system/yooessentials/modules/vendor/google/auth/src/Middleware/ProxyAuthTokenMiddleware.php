 ...
 */
namespace ZOOlanders\YOOessentials\Vendor\Google\Auth\Middleware;

use ZOOlanders\YOOessentials\Vendor\Google\Auth\FetchAuthTokenInterface;
...
class ProxyAuthTokenMiddleware
{
     ...
     */
    public function __construct(\ZOOlanders\YOOessentials\Vendor\Google\Auth\FetchAuthTokenInterface $fetcher, callable $httpHandler = null, callable $tokenCallback = null)
    {
    ...
    {
        return function (\ZOOlanders\YOOessentials\Vendor\Psr\Http\Message\RequestInterface $request, array $options) use($handler) {
            ...
            if ($quotaProject = $this->getQuotaProject()) {
                $request = $request->withHeader(\ZOOlanders\YOOessentials\Vendor\Google\Auth\GetQuotaProjectInterface::X_GOOG_USER_PROJECT_HEADER, $quotaProject);
            }
            return $handler($request, $options);
        };
    }
