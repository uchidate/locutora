 ...
 */
final class TypedItem implements \ZOOlanders\YOOessentials\Vendor\Psr\Cache\CacheItemInterface
{
    /**
     * @var mixed
     */
     ...
     * {@inheritdoc}
     */
    public function set(mixed $value) : \ZOOlanders\YOOessentials\Vendor\static
    {
        $this->isHit = \true;
        $this->value = $value;
        return $this;
     ...
     * {@inheritdoc}
     */
    public function expiresAt($expiration) : \ZOOlanders\YOOessentials\Vendor\static
    {
     ...
     * {@inheritdoc}
     */
    public function expiresAfter($time) : \ZOOlanders\YOOessentials\Vendor\static
    {
        if (\is_int($time)) {
