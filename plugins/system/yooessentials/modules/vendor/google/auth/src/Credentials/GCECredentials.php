 ...
 */
namespace ZOOlanders\YOOessentials\Vendor\Google\Auth\Credentials;

use ZOOlanders\YOOessentials\Vendor\Google\Auth\CredentialsLoader;
use ZOOlanders\YOOessentials\Vendor\Google\Auth\GetQuotaProjectInterface;
...
use ZOOlanders\YOOessentials\Vendor\Google\Auth\Iam;
use ZOOlanders\YOOessentials\Vendor\Google\Auth\ProjectIdProviderInterface;
use ZOOlanders\YOOessentials\Vendor\Google\Auth\SignBlobInterface;
...
use ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Exception\ServerException;
 ...
 */
class GCECredentials extends \ZOOlanders\YOOessentials\Vendor\Google\Auth\CredentialsLoader implements \ZOOlanders\YOOessentials\Vendor\Google\Auth\SignBlobInterface, \ZOOlanders\YOOessentials\Vendor\Google\Auth\ProjectIdProviderInterface, \ZOOlanders\YOOessentials\Vendor\Google\Auth\GetQuotaProjectInterface
{
    // phpcs:disable
     ...
     */
    public function __construct(\ZOOlanders\YOOessentials\Vendor\Google\Auth\Iam $iam = null, $scope = null, $targetAudience = null, $quotaProject = null, $serviceAccountIdentity = null)
    {
        $this->iam = $iam;
    ...
    {
        $httpHandler = $httpHandler ?: \ZOOlanders\YOOessentials\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory::build(\ZOOlanders\YOOessentials\Vendor\Google\Auth\HttpHandler\HttpClientCache::getHttpClient());
        ...
        for ($i = 1; $i <= self::MAX_COMPUTE_PING_TRIES; $i++) {
            try {
                ...
                // the metadata resolution was particularly slow. The latter case is
                // "unlikely".
                $resp = $httpHandler(new \ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\Request('GET', $checkUri, [self::FLAVOR_HEADER => 'Google']), ['timeout' => self::COMPUTE_PING_CONNECTION_TIMEOUT_S]);
                return $resp->getHeaderLine(self::FLAVOR_HEADER) == 'Google';
            } catch (\ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Exception\ClientException $e) {
            } catch (\ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Exception\ServerException $e) {
            } catch (\ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Exception\RequestException $e) {
            } catch (\ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Exception\ConnectException $e) {
            }
        }
        return \false;
    }
    ...
    {
        $httpHandler = \ZOOlanders\YOOessentials\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory::build(\ZOOlanders\YOOessentials\Vendor\Google\Auth\HttpHandler\HttpClientCache::getHttpClient());
        ...
        $signer = $this->iam ?: new \ZOOlanders\YOOessentials\Vendor\Google\Auth\Iam($httpHandler);
    ...
    {
        $resp = $httpHandler(new \ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\Request('GET', $uri, [self::FLAVOR_HEADER => 'Google']));
