 ...
 */
use ZOOlanders\YOOessentials\Vendor\google\appengine\api\app_identity\AppIdentityService;
 ...
 * ```
 */
class AppIdentityCredentials extends \ZOOlanders\YOOessentials\Vendor\Google\Auth\CredentialsLoader implements \ZOOlanders\YOOessentials\Vendor\Google\Auth\SignBlobInterface, \ZOOlanders\YOOessentials\Vendor\Google\Auth\ProjectIdProviderInterface
{
    /**
    ...
    public function fetchAuthToken(callable $httpHandler = null)
    {
        ...
        $token = \ZOOlanders\YOOessentials\Vendor\google\appengine\api\app_identity\AppIdentityService::getAccessToken($this->scope);
    ...
    public function signBlob($stringToSign, $forceOpenSsl = \false)
    {
        $this->checkAppEngineContext();
        /** @phpstan-ignore-next-line */
        return \base64_encode(\ZOOlanders\YOOessentials\Vendor\google\appengine\api\app_identity\AppIdentityService::signForApp($stringToSign)['signature']);
    }
    /**
    ...
    public function getProjectId(callable $httpHandler = null)
    {
        ...
        /** @phpstan-ignore-next-line */
        return \ZOOlanders\YOOessentials\Vendor\google\appengine\api\app_identity\AppIdentityService::getApplicationId();
    }
    /**
    ...
    public function getClientName(callable $httpHandler = null)
    {
        ...
        if (!$this->clientName) {
            /** @phpstan-ignore-next-line */
            $this->clientName = \ZOOlanders\YOOessentials\Vendor\google\appengine\api\app_identity\AppIdentityService::getServiceAccountName();
        }
    ...
    {
        if (!self::onAppEngine() || !\class_exists('ZOOlanders\\YOOessentials\\Vendor\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
