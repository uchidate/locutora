...
class Model implements \ArrayAccess
{
    ...
    {
        if ($value instanceof \ZOOlanders\YOOessentials\Vendor\Google\Model) {
    ...
    {
        if ($obj && !\is_array($obj)) {
            throw new \ZOOlanders\YOOessentials\Vendor\Google\Exception("Incorrect parameter type passed to {$method}(). Expected an array.");
        }
    }
    /** @return bool */
