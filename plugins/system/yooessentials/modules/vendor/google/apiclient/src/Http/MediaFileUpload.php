...
use ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\Uri;
...
class MediaFileUpload
{
     ...
     */
    public function __construct(\ZOOlanders\YOOessentials\Vendor\Google\Client $client, \ZOOlanders\YOOessentials\Vendor\Psr\Http\Message\RequestInterface $request, $mimeType, $data, $resumable = \false, $chunkSize = 0)
    {
        $this->client = $client;
    ...
    public function nextChunk($chunk = \false)
    {
        ...
        $request = new \ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\Request('PUT', $resumeUri, $headers, \ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\Utils::streamFor($chunk));
     ...
     *
     */
    private function makePutRequest(\ZOOlanders\YOOessentials\Vendor\Psr\Http\Message\RequestInterface $request)
    {
        ...
        return \ZOOlanders\YOOessentials\Vendor\Google\Http\REST::decodeHttpResponse($response, $this->request);
    }
    /**
    ...
    public function resume($resumeUri)
    {
        ...
        $httpRequest = new \ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\Request('PUT', $this->resumeUri, $headers);
    ...
    private function process()
    {
        ...
        $request = $request->withUri(\ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\Uri::withQueryValue($request->getUri(), 'uploadType', $uploadType));
        ...
        $request = $request->withBody(\ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\Utils::streamFor($postBody));
        if ($contentType) {
    ...
    private function fetchResumeUri()
    {
        ...
        throw new \ZOOlanders\YOOessentials\Vendor\Google\Exception($error);
    }
    private function transformToUploadUrl()
    {
        ...
        $uri = \ZOOlanders\YOOessentials\Vendor\GuzzleHttp\Psr7\Uri::fromParts($parts);
