...
use ZOOlanders\YOOessentials\Vendor\Composer\Script\Event;
use InvalidArgumentException;
use ZOOlanders\YOOessentials\Vendor\Symfony\Component\Filesystem\Filesystem;
use ZOOlanders\YOOessentials\Vendor\Symfony\Component\Finder\Finder;
class Composer
{
    /**
     ...
     */
    public static function cleanup(\ZOOlanders\YOOessentials\Vendor\Composer\Script\Event $event, \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Filesystem\Filesystem $filesystem = null)
    {
        ...
        if ($servicesToKeep) {
            ...
            $filesystem = $filesystem ?: new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Filesystem\Filesystem();
    ...
    {
        $finder = (new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Finder\Finder())->directories()->depth('== 0');
    ...
    private static function getServicesToRemove($serviceDir, array $servicesToKeep)
    {
        ...
        return (new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Finder\Finder())->directories()->depth('== 0')->in($serviceDir)->exclude($servicesToKeep);
    }
}
