...
class CopyPasteRequest extends \ZOOlanders\YOOessentials\Vendor\Google\Model
{
    protected $destinationType = \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\GridRange::class;
     ...
     * @param GridRange
     */
    public function setDestination(\ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\GridRange $destination)
    {
...
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\CopyPasteRequest::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_Sheets_CopyPasteRequest');
