 ...
 * the License.
 */
namespace ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\Resource;

use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\AppendValuesResponse;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchClearValuesByDataFilterRequest;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchClearValuesByDataFilterResponse;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchClearValuesRequest;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchClearValuesResponse;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchGetValuesByDataFilterRequest;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchGetValuesByDataFilterResponse;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchGetValuesResponse;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchUpdateValuesByDataFilterRequest;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchUpdateValuesByDataFilterResponse;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchUpdateValuesRequest;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchUpdateValuesResponse;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\ClearValuesRequest;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\ClearValuesResponse;
use ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\UpdateValuesResponse;
 ...
 *  </code>
 */
class SpreadsheetsValues extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
     ...
     */
    public function append($spreadsheetId, $range, \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\ValueRange $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'range' => $range, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('append', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\AppendValuesResponse::class);
    }
    /**
     ...
     */
    public function batchClear($spreadsheetId, \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchClearValuesRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchClear', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchClearValuesResponse::class);
    }
    /**
     * Clears one or more ranges of values from a spreadsheet. The caller must
     ...
     */
    public function batchClearByDataFilter($spreadsheetId, \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchClearValuesByDataFilterRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchClearByDataFilter', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchClearValuesByDataFilterResponse::class);
    }
    /**
    ...
    public function batchGet($spreadsheetId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('batchGet', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchGetValuesResponse::class);
    }
    /**
     ...
     */
    public function batchGetByDataFilter($spreadsheetId, \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchGetValuesByDataFilterRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchGetByDataFilter', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchGetValuesByDataFilterResponse::class);
    }
    /**
     ...
     */
    public function batchUpdate($spreadsheetId, \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchUpdateValuesRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchUpdate', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchUpdateValuesResponse::class);
    }
    /**
     * Sets values in one or more ranges of a spreadsheet. The caller must specify
     ...
     */
    public function batchUpdateByDataFilter($spreadsheetId, \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchUpdateValuesByDataFilterRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchUpdateByDataFilter', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchUpdateValuesByDataFilterResponse::class);
    }
    /**
     ...
     */
    public function clear($spreadsheetId, $range, \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\ClearValuesRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'range' => $range, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('clear', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\ClearValuesResponse::class);
    }
    /**
    ...
    public function get($spreadsheetId, $range, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\ValueRange::class);
    }
    /**
     ...
     */
    public function update($spreadsheetId, $range, \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\ValueRange $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'range' => $range, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\UpdateValuesResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\Resource\SpreadsheetsValues::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_Sheets_Resource_SpreadsheetsValues');
