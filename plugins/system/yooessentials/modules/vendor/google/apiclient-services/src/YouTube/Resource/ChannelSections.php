...
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ChannelSection;
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ChannelSectionListResponse;
/**
 ...
 *  </code>
 */
class ChannelSections extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
     ...
     */
    public function insert($part, \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ChannelSection $postBody, $optParams = [])
    {
        $params = ['part' => $part, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ChannelSection::class);
    }
    /**
    ...
    public function listChannelSections($part, $optParams = [])
    {
        $params = ['part' => $part];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ChannelSectionListResponse::class);
    }
    /**
     ...
     * @return ChannelSection
     */
    public function update($part, \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ChannelSection $postBody, $optParams = [])
    {
        $params = ['part' => $part, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ChannelSection::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Resource\ChannelSections::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_YouTube_Resource_ChannelSections');
