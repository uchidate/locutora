...
use ZOOlanders\YOOessentials\Vendor\Google\Service\MyBusinessAccountManagement\ListAccountAdminsResponse;
 ...
 *  </code>
 */
class AccountsAdmins extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
    ...
    public function listAccountsAdmins($parent, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\MyBusinessAccountManagement\ListAccountAdminsResponse::class);
    }
    /**
...
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\MyBusinessAccountManagement\Resource\AccountsAdmins::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_MyBusinessAccountManagement_Resource_AccountsAdmins');
