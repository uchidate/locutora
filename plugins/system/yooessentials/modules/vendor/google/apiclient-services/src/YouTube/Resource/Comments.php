...
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Comment;
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\CommentListResponse;
/**
...
class Comments extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
     ...
     * @return Comment
     */
    public function insert($part, \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Comment $postBody, $optParams = [])
    {
        $params = ['part' => $part, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Comment::class);
    }
    /**
    ...
    public function listComments($part, $optParams = [])
    {
        $params = ['part' => $part];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\CommentListResponse::class);
    }
    /**
     ...
     * @return Comment
     */
    public function update($part, \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Comment $postBody, $optParams = [])
    {
        $params = ['part' => $part, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Comment::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Resource\Comments::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_YouTube_Resource_Comments');
