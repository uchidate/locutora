...
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ThumbnailSetResponse;
/**
 ...
 *  </code>
 */
class Thumbnails extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
    ...
    public function set($videoId, $optParams = [])
    {
        ...
        return $this->call('set', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ThumbnailSetResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Resource\Thumbnails::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_YouTube_Resource_Thumbnails');
