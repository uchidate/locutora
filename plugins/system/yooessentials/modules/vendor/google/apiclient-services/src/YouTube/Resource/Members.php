...
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\MemberListResponse;
/**
 ...
 *  </code>
 */
class Members extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
    ...
    public function listMembers($part, $optParams = [])
    {
        ...
        return $this->call('list', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\MemberListResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Resource\Members::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_YouTube_Resource_Members');
