...
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\CommentThread;
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\CommentThreadListResponse;
/**
 ...
 *  </code>
 */
class CommentThreads extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
     ...
     */
    public function insert($part, \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\CommentThread $postBody, $optParams = [])
    {
        $params = ['part' => $part, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\CommentThread::class);
    }
    /**
    ...
    public function listCommentThreads($part, $optParams = [])
    {
        $params = ['part' => $part];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\CommentThreadListResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Resource\CommentThreads::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_YouTube_Resource_CommentThreads');
