...
class BatchUpdateValuesResponse extends \ZOOlanders\YOOessentials\Vendor\Google\Collection
{
    protected $collection_key = 'responses';
    protected $responsesType = \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\UpdateValuesResponse::class;
...
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchUpdateValuesResponse::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_Sheets_BatchUpdateValuesResponse');
