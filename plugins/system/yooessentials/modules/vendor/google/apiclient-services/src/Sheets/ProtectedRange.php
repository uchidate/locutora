...
class ProtectedRange extends \ZOOlanders\YOOessentials\Vendor\Google\Collection
{
     ...
     */
    public $description;
    protected $editorsType = \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\Editors::class;
    ...
    protected $unprotectedRangesType = \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\GridRange::class;
     ...
     * @param Editors
     */
    public function setEditors(\ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\Editors $editors)
    {
...
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\ProtectedRange::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_Sheets_ProtectedRange');
