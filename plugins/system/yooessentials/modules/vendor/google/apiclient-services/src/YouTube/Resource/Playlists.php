...
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Playlist;
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\PlaylistListResponse;
/**
 ...
 *  </code>
 */
class Playlists extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
     ...
     * @return Playlist
     */
    public function insert($part, \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Playlist $postBody, $optParams = [])
    {
        $params = ['part' => $part, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Playlist::class);
    }
    /**
    ...
    public function listPlaylists($part, $optParams = [])
    {
        $params = ['part' => $part];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\PlaylistListResponse::class);
    }
    /**
     ...
     * @return Playlist
     */
    public function update($part, \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Playlist $postBody, $optParams = [])
    {
        $params = ['part' => $part, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Playlist::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Resource\Playlists::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_YouTube_Resource_Playlists');
