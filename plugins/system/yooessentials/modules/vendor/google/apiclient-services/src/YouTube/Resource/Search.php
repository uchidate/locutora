...
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\SearchListResponse;
/**
 ...
 *  </code>
 */
class Search extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
    ...
    public function listSearch($part, $optParams = [])
    {
        ...
        return $this->call('list', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\SearchListResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Resource\Search::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_YouTube_Resource_Search');
