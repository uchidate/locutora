...
class About extends \ZOOlanders\YOOessentials\Vendor\Google\Collection
{
    ...
    protected $driveThemesType = \ZOOlanders\YOOessentials\Vendor\Google\Service\Drive\AboutDriveThemes::class;
    ...
    protected $storageQuotaType = \ZOOlanders\YOOessentials\Vendor\Google\Service\Drive\AboutStorageQuota::class;
    protected $storageQuotaDataType = '';
    protected $teamDriveThemesType = \ZOOlanders\YOOessentials\Vendor\Google\Service\Drive\AboutTeamDriveThemes::class;
    protected $teamDriveThemesDataType = 'array';
    protected $userType = \ZOOlanders\YOOessentials\Vendor\Google\Service\Drive\User::class;
     ...
     */
    public function setStorageQuota(\ZOOlanders\YOOessentials\Vendor\Google\Service\Drive\AboutStorageQuota $storageQuota)
    {
     ...
     * @param User
     */
    public function setUser(\ZOOlanders\YOOessentials\Vendor\Google\Service\Drive\User $user)
    {
        $this->user = $user;
    }
    /**
...
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\Drive\About::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_Drive_About');
