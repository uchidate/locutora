...
class BatchUpdateValuesByDataFilterRequest extends \ZOOlanders\YOOessentials\Vendor\Google\Collection
{
    protected $collection_key = 'data';
    protected $dataType = \ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\DataFilterValueRange::class;
...
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\Sheets\BatchUpdateValuesByDataFilterRequest::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_Sheets_BatchUpdateValuesByDataFilterRequest');
