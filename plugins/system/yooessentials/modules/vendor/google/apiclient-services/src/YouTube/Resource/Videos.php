...
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Video;
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\VideoAbuseReport;
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\VideoGetRatingResponse;
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\VideoListResponse;
/**
 ...
 *  </code>
 */
class Videos extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
    ...
    public function getRating($id, $optParams = [])
    {
        $params = ['id' => $id];
        $params = \array_merge($params, $optParams);
        return $this->call('getRating', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\VideoGetRatingResponse::class);
    }
    /**
     ...
     * @return Video
     */
    public function insert($part, \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Video $postBody, $optParams = [])
    {
        $params = ['part' => $part, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Video::class);
    }
    /**
    ...
    public function listVideos($part, $optParams = [])
    {
        $params = ['part' => $part];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\VideoListResponse::class);
    }
    /**
     ...
     * the specified YouTube content owner.
     */
    public function reportAbuse(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\VideoAbuseReport $postBody, $optParams = [])
    {
     ...
     * @return Video
     */
    public function update($part, \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Video $postBody, $optParams = [])
    {
        $params = ['part' => $part, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Video::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Resource\Videos::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_YouTube_Resource_Videos');
