 ...
 *  </code>
 */
class YoutubeV3LiveBroadcastsCuepoint extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
    ...
    public function create($optParams = [])
    {
        ...
        return $this->call('create', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Cuepoint::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Resource\YoutubeV3LiveBroadcastsCuepoint::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_YouTube_Resource_YoutubeV3LiveBroadcastsCuepoint');
