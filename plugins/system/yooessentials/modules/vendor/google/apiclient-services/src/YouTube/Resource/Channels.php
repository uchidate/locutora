...
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Channel;
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ChannelListResponse;
/**
 ...
 *  </code>
 */
class Channels extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
    ...
    public function listChannels($part, $optParams = [])
    {
        ...
        return $this->call('list', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ChannelListResponse::class);
    }
    /**
     ...
     * @return Channel
     */
    public function update($part, \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Channel $postBody, $optParams = [])
    {
        $params = ['part' => $part, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Channel::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Resource\Channels::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_YouTube_Resource_Channels');
