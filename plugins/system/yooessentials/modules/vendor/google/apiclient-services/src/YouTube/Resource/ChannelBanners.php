...
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ChannelBannerResource;
/**
 ...
 *  </code>
 */
class ChannelBanners extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
     ...
     */
    public function insert(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ChannelBannerResource $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\ChannelBannerResource::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Resource\ChannelBanners::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_YouTube_Resource_ChannelBanners');
