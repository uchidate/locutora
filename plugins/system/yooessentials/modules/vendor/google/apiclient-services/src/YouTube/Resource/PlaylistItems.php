...
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\PlaylistItem;
use ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\PlaylistItemListResponse;
/**
 ...
 *  </code>
 */
class PlaylistItems extends \ZOOlanders\YOOessentials\Vendor\Google\Service\Resource
{
    /**
     ...
     * @return PlaylistItem
     */
    public function insert($part, \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\PlaylistItem $postBody, $optParams = [])
    {
        $params = ['part' => $part, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\PlaylistItem::class);
    }
    /**
    ...
    public function listPlaylistItems($part, $optParams = [])
    {
        $params = ['part' => $part];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\PlaylistItemListResponse::class);
    }
    /**
     ...
     * @return PlaylistItem
     */
    public function update($part, \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\PlaylistItem $postBody, $optParams = [])
    {
        $params = ['part' => $part, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\PlaylistItem::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ZOOlanders\YOOessentials\Vendor\Google\Service\YouTube\Resource\PlaylistItems::class, 'ZOOlanders\\YOOessentials\\Vendor\\Google_Service_YouTube_Resource_PlaylistItems');
