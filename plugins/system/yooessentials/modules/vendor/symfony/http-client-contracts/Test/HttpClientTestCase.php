 ...
 */
namespace ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Test;
 ...
 */
abstract class HttpClientTestCase extends \ZOOlanders\YOOessentials\Vendor\PHPUnit\Framework\TestCase
{
    public static function setUpBeforeClass() : void
    {
        \ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Test\TestHttpServer::start();
    }
    protected abstract function getHttpClient(string $testCase) : \ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\HttpClientInterface;
    public function testGetRequest()
    {
        ...
        $this->expectException(\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class);
        $response->getContent();
    }
    ...
    public function testClientError()
    {
        ...
        try {
            $response->getHeaders();
            $this->fail(\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface::class . ' expected');
        } catch (\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface $e) {
        }
        try {
            $response->getContent();
            $this->fail(\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface::class . ' expected');
    ...
    public function testDnsError()
    {
        ...
        try {
            ...
            $this->fail(\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class . ' expected');
        } catch (\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface $e) {
            $this->addToAssertionCount(1);
        }
        try {
            $response->getStatusCode();
            $this->fail(\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class . ' still expected');
        } catch (\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface $e) {
            $this->addToAssertionCount(1);
        }
        $response = $client->request('GET', 'http://localhost:8057/301/bad-tld');
    ...
    public function testInvalidRedirect()
    {
        ...
        $this->assertNull($response->getInfo('redirect_url'));
        $this->expectException(\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface::class);
        $response->getHeaders();
    }
    ...
    public function testMaxRedirects()
    {
        ...
        try {
            $response->getHeaders();
            $this->fail(\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface::class . ' expected');
        } catch (\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface $e) {
        }
        $this->assertSame(302, $response->getStatusCode());
    ...
    public function testTimeoutIsNotAFatalError()
    {
        ...
        try {
            $response->getContent();
            $this->fail(\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface::class . ' expected');
        } catch (\ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface $e) {
        }
        for ($i = 0; $i < 10; ++$i) {
            try {
    ...
    {
        $p1 = \ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8067);
        $p2 = \ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8077);
        $client = $this->getHttpClient(__FUNCTION__);
