 ...
 */
abstract class AbstractMultipartPart extends \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Mime\Part\AbstractPart
{
    private $boundary;
    private $parts = [];
    public function __construct(\ZOOlanders\YOOessentials\Vendor\Symfony\Component\Mime\Part\AbstractPart ...$parts)
    {
        parent::__construct();
