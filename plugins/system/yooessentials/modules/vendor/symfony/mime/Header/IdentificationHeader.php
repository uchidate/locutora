 ...
 * @author Chris Corbyn
 */
final class IdentificationHeader extends \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Mime\Header\AbstractHeader
{
    private $ids = [];
    ...
    public function setIds(array $ids)
    {
        ...
        $this->idsAsAddresses = [];
        foreach ($ids as $id) {
            $this->idsAsAddresses[] = new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Mime\Address($id);
            $this->ids[] = $id;
        }
    }
    /**
