 ...
 * @author Chris Corbyn
 */
final class MailboxListHeader extends \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\ZOOlanders\YOOessentials\Vendor\Symfony\Component\Mime\Address $address)
    {
