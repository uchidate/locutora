 ...
 * @author Chris Corbyn
 */
final class ParameterizedHeader extends \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Mime\Header\UnstructuredHeader
{
    /**
    ...
    public function __construct(string $name, string $value, array $parameters = [])
    {
        ...
        if ('content-type' !== \strtolower($name)) {
            $this->encoder = new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Mime\Encoder\Rfc2231Encoder();
        }
    }
