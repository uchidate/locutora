 ...
 * @author Chris Corbyn
 */
abstract class AbstractHeader implements \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Mime\Header\HeaderInterface
{
     ...
     */
    protected function createPhrase(\ZOOlanders\YOOessentials\Vendor\Symfony\Component\Mime\Header\HeaderInterface $header, string $string, string $charset, bool $shorten = \false) : string
    {
     ...
     */
    protected function encodeWords(\ZOOlanders\YOOessentials\Vendor\Symfony\Component\Mime\Header\HeaderInterface $header, string $input, int $usedLength = -1) : string
    {
        $value = '';
    ...
    protected function getTokenAsEncodedWord(string $token, int $firstLineOffset = 0) : string
    {
        if (null === self::$encoder) {
            self::$encoder = new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
        }
