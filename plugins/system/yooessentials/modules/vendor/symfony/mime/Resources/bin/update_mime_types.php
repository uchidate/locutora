...
// load new map
$data = \json_decode(\file_get_contents('https://cdn.jsdelivr.net/gh/jshttp/mime-db@v1.49.0/db.json'), \true);
$new = [];
...
foreach ($map as $mimeType => $extensions) {
    foreach ($exts as $ext => $types) {
        if (\in_array($mimeType, $types, \true)) {
