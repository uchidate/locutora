...
if (\interface_exists(\ZOOlanders\YOOessentials\Vendor\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ZOOlanders\YOOessentials\Vendor\Psr\Cache\CacheException, \ZOOlanders\YOOessentials\Vendor\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ZOOlanders\YOOessentials\Vendor\Psr\Cache\CacheException
    {
    }
}
