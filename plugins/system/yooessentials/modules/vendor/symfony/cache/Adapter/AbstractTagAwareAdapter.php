 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \ZOOlanders\YOOessentials\Vendor\Symfony\Contracts\Cache\TagAwareCacheInterface, \ZOOlanders\YOOessentials\Vendor\Psr\Log\LoggerAwareInterface, \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Cache\ResettableInterface
{
    ...
    {
        $this->namespace = '' === $namespace ? '' : \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Cache\CacheItem::validateKey($namespace) . ':';
        ...
        self::$createCacheItem ?? (self::$createCacheItem = \Closure::bind(static function ($key, $value, $isHit) {
            ...
            $item->metadata[\ZOOlanders\YOOessentials\Vendor\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = $value['tags'] ?? [];
            if (isset($value['meta'])) {
        ...
        self::$mergeByLifetime ?? (self::$mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds, $getId, $tagPrefix, $defaultLifetime) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\ZOOlanders\YOOessentials\Vendor\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\ZOOlanders\YOOessentials\Vendor\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = $item->metadata[\ZOOlanders\YOOessentials\Vendor\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
    ...
    public function deleteItems(array $keys) : bool
    {
        ...
        foreach ($ids as $key => $id) {
            ...
            \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Cache\CacheItem::log($this->logger, $message, ['key' => $key, 'exception' => $e, 'cache-adapter' => \get_debug_type($this)]);
            $ok = \false;
        }
        return $ok;
    }
    ...
    public function invalidateTags(array $tags)
    {
        ...
        try {
            ...
            \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to invalidate tags: ' . $e->getMessage(), ['exception' => $e, 'cache-adapter' => \get_debug_type($this)]);
        }
        return \false;
    }
    /**
