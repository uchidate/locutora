...
if (!\function_exists('idn_to_ascii')) {
    ...
    {
        return \ZOOlanders\YOOessentials\Vendor\Symfony\Polyfill\Intl\Idn\Idn::idn_to_ascii((string) $domain, (int) $flags, (int) $variant, $idna_info);
    }
}
if (!\function_exists('idn_to_utf8')) {
    ...
    {
        return \ZOOlanders\YOOessentials\Vendor\Symfony\Polyfill\Intl\Idn\Idn::idn_to_utf8((string) $domain, (int) $flags, (int) $variant, $idna_info);
    }
}
