...
class Exporter
{
    ...
    public static function prepare($values, $objectsPool, &$refsPool, &$objectsCount, &$valuesAreStatic) : array
    {
        ...
        foreach ($values as $k => $value) {
            if (\is_resource($value)) {
                throw new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException(\get_resource_type($value) . ' resource');
            }
            $refs[$k] = $objectsPool;
            if ($isRef = !($valueIsStatic = $values[$k] !== $objectsPool)) {
                ...
                if ($value instanceof \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Reference && 0 > $value->id) {
                    $valuesAreStatic = \false;
                    ++$value->count;
                    continue;
                }
                $refsPool[] = [&$refs[$k], $value, &$value];
                $refs[$k] = $values[$k] = new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Reference(-\count($refsPool), $value);
            }
            if (\is_array($value)) {
                if ($value) {
                ...
                goto handle_value;
            } elseif (!\is_object($value) || $value instanceof \ZOOlanders\YOOessentials\Vendor\UnitEnum) {
                goto handle_value;
            }
            $valueIsStatic = \false;
            if (isset($objectsPool[$value])) {
                ++$objectsCount;
                $value = new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Reference($objectsPool[$value][0]);
                goto handle_value;
            }
            $class = \get_class($value);
            $reflector = \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$class] ?? \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($class);
            ...
            $properties = [];
            $sleep = null;
            $proto = \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class];
            if (($value instanceof \ArrayIterator || $value instanceof \ArrayObject) && null !== $proto) {
                ...
                \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($class, \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class], \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]);
            } elseif ($value instanceof \SplObjectStorage && \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class] && null !== $proto) {
                ...
                $value = new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Reference($id);
                goto handle_value;
            } else {
    ...
    public static function export($value, string $indent = '')
    {
        switch (\true) {
            ...
            case '' === $value:
                return "''";
            case $value instanceof \ZOOlanders\YOOessentials\Vendor\UnitEnum:
                return \ltrim(\var_export($value, \true), '\\');
        }
        if ($value instanceof \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Reference) {
            if (0 <= $value->id) {
                return '$o[' . $value->id . ']';
            }
            if (!$value->count) {
        ...
        if ($value instanceof \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Values) {
            $code = $subIndent . "\$r = [],\n";
        ...
        if ($value instanceof \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry) {
            return self::exportRegistry($value, $indent, $subIndent);
        }
        if ($value instanceof \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Hydrator) {
    ...
    private static function exportRegistry(\ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry $value, string $indent, string $subIndent) : string
    {
        $code = '';
        $serializables = [];
        $seen = [];
        $prototypesAccess = 0;
        $factoriesAccess = 0;
        $r = '\\' . \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry::class;
        $j = -1;
        foreach ($value->classes as $k => $class) {
            ...
            if (!\ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            ...
            $c = '[' . self::export($class) . ']';
            if ($seen[$class] ?? \false) {
                if (\ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
                    ++$prototypesAccess;
                    $code .= 'clone $p' . $c;
                } else {
                    ++$factoriesAccess;
    ...
    private static function exportHydrator(\ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Hydrator $value, string $indent, string $subIndent) : string
    {
        $code = '';
    ...
    private static function getArrayObjectProperties($value, $proto) : array
    {
        ...
        $reflector = \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$reflector] ?? \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($reflector);
