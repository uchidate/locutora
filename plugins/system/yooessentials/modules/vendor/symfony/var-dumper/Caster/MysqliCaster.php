...
{
    public static function castMysqliDriver(\mysqli_driver $c, array $a, \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested) : array
    {
        foreach ($a as $k => $v) {
            if (isset($c->{$k})) {
                $a[$k] = $c->{$k};
