...
class XmlResourceCaster
{
    ...
    public static function castXml($h, array $a, \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        ...
        if (isset(self::XML_ERRORS[$a['error_code']])) {
            $a['error_code'] = new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Caster\ConstStub(self::XML_ERRORS[$a['error_code']], $a['error_code']);
        }
        return $a;
    }
}
