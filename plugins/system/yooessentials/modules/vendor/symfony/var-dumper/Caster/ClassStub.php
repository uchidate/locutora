 ...
 */
class ClassStub extends \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Cloner\Stub(), \true, \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
