...
use ZOOlanders\YOOessentials\Vendor\Symfony\Component\Console\Input\ArrayInput;
 ...
 * @final
 */
class CliDescriptor implements \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    public function __construct(\ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
    }
    ...
    {
        $io = $output instanceof \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Console\Style\SymfonyStyle(new \ZOOlanders\YOOessentials\Vendor\Symfony\Component\Console\Input\ArrayInput([]), $output);
