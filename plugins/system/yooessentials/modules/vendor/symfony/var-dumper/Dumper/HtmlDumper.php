 ...
 */
class HtmlDumper extends \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
     ...
     * {@inheritdoc}
     */
    public function dump(\ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Cloner\Data $data, $output = null, array $extraDisplayOptions = [])
    {
...
EOHTML
    ...
    public function enterHash(\ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Cloner\Cursor $cursor, int $type, $class, bool $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine(int $depth, bool $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \ZOOlanders\YOOessentials\Vendor\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
