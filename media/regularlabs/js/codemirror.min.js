 ...
 */
"use strict";if(typeof window.RegularLabsCodeMirror==='undefined'||typeof RegularLabsCodeMirror.version==='undefined'||RegularLabsCodeMirror.version<'22.4.22216'){(function($){window.RegularLabsCodeMirror={version:'22.4.22216',init:function(id){if(!$(`#rl_codemirror_${id}.CodeMirror`).length){setTimeout(function(){RegularLabsCodeMirror.init(id);},100);return;}
