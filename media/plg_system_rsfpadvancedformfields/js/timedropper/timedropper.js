        ...
        return $(this).each(function() {
            ...
            var
                ...
                _td_rotation = function(deg) {
                    ...
                    if (!_td_options.setCurrentTime && _td_first)
                    {
                        return;
                    }
                    ...
                    var date = new Date();
                    date.setHours(_td_h);
                    date.setMinutes(_td_m);

                    _td_input.attr('data-rsfp-unixtimestamp', date.getTime() / 1000);

                    RSFormPro.triggerEvent(_td_input[0], 'input');
                };
